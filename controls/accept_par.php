...
if($upd){
    ...
    while($row = $get->fetch(PDO:: FETCH_ASSOC))
    {
        ...
        if($row > 0)
        {           
            //SEND EMAIL NOTIFICATION TO APPROVER 1
                            ...
                            <head>
                                ...
                                <body style='margin: 0 auto; padding: 10px; border: 1px solid #e1e1e1; font-family:Calibri'>
                                    ...
                                    <div style='border: 1px solid #e1e1e1; padding: 5px'>    
                                        Hi ".$fname.", <br><br> <b>".$_POST['name']."</b> online PAR has been approved by <b>".$_SESSION['fullname']."</b> and the document is now ready for printing.<br><br>
