...
if(!empty($_GET['id']))
{
	...
	//from eval page
	$par->id = $par_id;//sup_id from par_details
	$get = $par->get_unevaluated_par();
	while($row = $get->fetch(PDO::FETCH_ASSOC))
	{
		...
		$tbl1 .= '<tr>
				...
				<tr>
					...
					<td style="border: 1px solid black" colspan="3" align="center"><b>'.$row['rater_name'].'</b></td>
				</tr>';
		//KRA & KPI
		$tbl2 .= '<tr>
					...
					<td width="15%" style="border-top-style:1px; border-bottom-style:1px; border-right-style:1px" align="center" rowspan="2">RATE <br><br>'.$row['rate1'].'</td>
					<td width="37%" style="border-top-style:1px; border-bottom-style:1px; border-right-style:1px" rowspan="2">COMMENTS <br>'.$row['comments1'].'</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td width="15%" style="border-bottom-style:1px; border-right-style:1px" align="center" rowspan="2">RATE <br><br>'.$row['rate2'].'</td>
					<td width="37%" style="border-bottom-style:1px; border-right-style:1px" rowspan="2">COMMENTS <br>'.$row['comments2'].'</td>
				</tr>
				<tr>
					<td width="3%" style="border-bottom-style:1px; border-left-style:1px"></td>
				...
				<tr>
					...
					<td width="15%" style="border-bottom-style:1px; border-right-style:1px" align="center" rowspan="2">RATE <br><br>'.$row['rate3'].'</td>
					<td width="37%" style="border-bottom-style:1px; border-right-style:1px" rowspan="2">COMMENTS <br>'.$row['comments3'].'</td>
				</tr>
				<tr>
					<td width="3%" style="border-bottom-style:1px; border-left-style:1px"></td>
				...
				<tr>
					...
					<td width="15%" style="border-bottom-style:1px; border-right-style:1px" align="center" rowspan="2">RATE <br><br>'.$row['rate4'].'</td>
					<td width="37%" style="border-bottom-style:1px; border-right-style:1px" rowspan="2">COMMENTS <br>'.$row['comments4'].'</td>
				</tr>
				<tr>
					<td width="3%" style="border-bottom-style:1px; border-left-style:1px"></td>
				...
				<tr>
					...
					<td width="15%" style="border-bottom-style:1px; border-right-style:1px" align="center" rowspan="2">RATE <br><br>'.$row['rate5'].'</td>
					<td width="37%" style="border-bottom-style:1px; border-right-style:1px" rowspan="2">COMMENTS <br>'.$row['comments5'].'</td>
				</tr>
				<tr>
					<td width="3%" style="border-bottom-style:1px; border-left-style:1px"></td>
				...
				<tr>
					...
					<td width="15%" style="border-bottom-style:1px; border-right-style:1px" align="center" rowspan="2">RATE <br><br>'.$row['rate6'].'</td>
					<td width="37%" style="border-bottom-style:1px; border-right-style:1px" rowspan="2">COMMENTS <br>'.$row['comments6'].'</td>
				</tr>
				<tr>
					<td width="3%" style="border-bottom-style:1px; border-left-style:1px"></td>
		...
		$tbl6 .= '<tr>
				...
				<tr>
					<td width="100%" style="border-style:solid black 1px; border-left-style: 1px" rowspan="4">'.$row['emp_comment'].'</td>
				</tr>
				<tr>
					<td></td>
				</tr>
				...
				<tr>
					<td width="50%" style="border-top-style:1px; border-left-style: 1px" rowspan="3"></td>
					<td width="50%" style="border-top-style:1px; border-right-style:1px; border-left-style: 1px" rowspan="3"></td>
				</tr>
				<tr>
					<td></td>
				</tr>
				...
				<tr>
					<td width="50%" style="border-left-style: 1px" rowspan="3"></td>
					<td width="50%" style="border-right-style:1px; border-left-style: 1px" rowspan="3"></td>
				</tr>
				<tr>
					<td></td>
				</tr>
...
else
{
	...
	//RECOMMENDATION
	//$data1 = explode(',', $_GET['recommendation']);
	...
	$tbl1 .= '<tr>
			...
			<tr>
				...
				<td style="border: 1px solid black">Date Hire</td>
				<td style="border: 1px solid black">'.$_GET['date_hire'].'</td>
			</tr>
			<tr>
				<td style="border: 1px solid black">Position Title</td>
	...
	$tbl2 .= '<tr>
				<td width="3%" style="border-top-style:1px; border-bottom-style:1px; border-left-style:1px">A.</td>
				<td width="45%" style="border-top-style:1px; border-bottom-style:1px; border-right-style:1px">KRA <br>'.$_GET['kra1'].'</td>
				<td width="15%" style="border-top-style:1px; border-bottom-style:1px; border-right-style:1px" align="center" rowspan="2">RATE <br><br>'.$_GET['kra_rating1'].'</td>
				<td width="37%" style="border-top-style:1px; border-bottom-style:1px; border-right-style:1px" rowspan="2">COMMENTS <br>'.$_GET['comments1'].'</td>
			</tr>
			<tr>
				<td width="3%" style="border-bottom-style:1px; border-left-style:1px"></td>
				<td width="45%" style="border-bottom-style:1px; border-right-style:1px">KPI <br>'.$_GET['kpi1'].'</td>
			</tr>
			<tr>
				<td width="3%" style="border-bottom-style:1px; border-left-style:1px">B.</td>
				<td width="45%" style="border-bottom-style:1px; border-right-style:1px">KRA <br>'.$_GET['kra2'].'</td>
				<td width="15%" style="border-bottom-style:1px; border-right-style:1px" align="center" rowspan="2">RATE <br><br>'.$_GET['kra_rating2'].'</td>
				<td width="37%" style="border-bottom-style:1px; border-right-style:1px" rowspan="2">COMMENTS <br>'.$_GET['comments2'].'</td>
			</tr>
			<tr>
				<td width="3%" style="border-bottom-style:1px; border-left-style:1px"></td>
				<td width="45%" style="border-bottom-style:1px; border-right-style:1px">KPI <br>'.$_GET['kpi2'].'</td>
			</tr>
			<tr>
				<td width="3%" style="border-bottom-style:1px; border-left-style:1px">C.</td>
				<td width="45%" style="border-bottom-style:1px; border-right-style:1px">KRA <br>'.$_GET['kra3'].'</td>
				<td width="15%" style="border-bottom-style:1px; border-right-style:1px" align="center" rowspan="2">RATE <br><br>'.$_GET['kra_rating3'].'</td>
				<td width="37%" style="border-bottom-style:1px; border-right-style:1px" rowspan="2">COMMENTS <br>'.$_GET['comments3'].'</td>
			</tr>
			<tr>
				<td width="3%" style="border-bottom-style:1px; border-left-style:1px"></td>
				<td width="45%" style="border-bottom-style:1px; border-right-style:1px">KPI <br>'.$_GET['kpi3'].'</td>
			</tr>
			<tr>
				<td width="3%" style="border-bottom-style:1px; border-left-style:1px">D.</td>
				<td width="45%" style="border-bottom-style:1px; border-right-style:1px">KRA <br>'.$_GET['kra4'].'</td>
				<td width="15%" style="border-bottom-style:1px; border-right-style:1px" align="center" rowspan="2">RATE <br><br>'.$_GET['kra_rating4'].'</td>
				<td width="37%" style="border-bottom-style:1px; border-right-style:1px" rowspan="2">COMMENTS <br>'.$_GET['comments4'].'</td>
			</tr>
			<tr>
				<td width="3%" style="border-bottom-style:1px; border-left-style:1px"></td>
				<td width="45%" style="border-bottom-style:1px; border-right-style:1px">KPI <br>'.$_GET['kpi4'].'</td>
			</tr>
			<tr>
				<td width="3%" style="border-bottom-style:1px; border-left-style:1px">E.</td>
				<td width="45%" style="border-bottom-style:1px; border-right-style:1px">KRA <br>'.$_GET['kra5'].'</td>
				<td width="15%" style="border-bottom-style:1px; border-right-style:1px" align="center" rowspan="2">RATE <br><br>'.$_GET['kra_rating5'].'</td>
				<td width="37%" style="border-bottom-style:1px; border-right-style:1px" rowspan="2">COMMENTS <br>'.$_GET['comments5'].'</td>
			</tr>
			<tr>
				<td width="3%" style="border-bottom-style:1px; border-left-style:1px"></td>
				<td width="45%" style="border-bottom-style:1px; border-right-style:1px">KPI <br>'.$_GET['kpi5'].'</td>
			</tr>
			<tr>
				<td width="3%" style="border-bottom-style:1px; border-left-style:1px">E.</td>
				<td width="45%" style="border-bottom-style:1px; border-right-style:1px">KRA <br>'.$_GET['kra6'].'</td>
				<td width="15%" style="border-bottom-style:1px; border-right-style:1px" align="center" rowspan="2">RATE <br><br>'.$_GET['kra_rating6'].'</td>
				<td width="37%" style="border-bottom-style:1px; border-right-style:1px" rowspan="2">COMMENTS <br>'.$_GET['comments6'].'</td>
			</tr>
			<tr>
				<td width="3%" style="border-bottom-style:1px; border-left-style:1px"></td>
				<td width="45%" style="border-bottom-style:1px; border-right-style:1px">KPI <br>'.$_GET['kpi6'].'</td>
			</tr>';
	//GENERAL PERFORMANCE
	$tbl3 .= '<tr>
				<td width="17%" style="border-top-style:1px; border-bottom-style:1px; border-left-style:1px"><b>BIAS FOR RESULTS</b></td>
	...
	$tbl5 .= '<tr>
			...
			<tr>
				<td width="100%" style="border-style:solid black 1px; border-left-style: 1px" rowspan="3">'.$_GET['emp_comment'].'</td>
			</tr>
			<tr>
				<td></td>
			</tr>';
