...
if($_GET['id'] != null)
{
	...
	$tbl5 = "";
	$tbl6 = "";
	$id = $_GET['id'];//par_details id
	//get the status of employee PAR
	$par->id = $id;
	$status = '';
	$sup_id = '';
	$get_stat = $par->get_par_status();
	while($row = $get_stat->fetch(PDO::FETCH_ASSOC))
	{
		$status = $row['par_status'];
		//get the sup_id of PAR if Evaluated
		$sup_id = $row['sup_id'];
	}
	
	if($status == 1)//unevaluated PAR
	{
		$par->id = $id;//par_details 
		...
		while($row = $get->fetch(PDO::FETCH_ASSOC))
		{
			...
			$tbl2 .= '<tr>
						...
						<td width="46%" style="border-top-style:1px; border-bottom-style:1px; border-right-style:1px" rowspan="2">EMPLOYEE COMMENTS <br>'.$row['comments1'].'</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td width="46%" style="border-bottom-style:1px; border-right-style:1px" rowspan="2">EMPLOYEE COMMENTS <br>'.$row['comments2'].'</td>
					</tr>
					<tr>
						<td width="3%" style="border-bottom-style:1px; border-left-style:1px"></td>
					...
					<tr>
						...
						<td width="46%" style="border-bottom-style:1px; border-right-style:1px" rowspan="2">EMPLOYEE COMMENTS <br>'.$row['comments3'].'</td>
					</tr>
					<tr>
						<td width="3%" style="border-bottom-style:1px; border-left-style:1px"></td>
					...
					<tr>
						...
						<td width="46%" style="border-bottom-style:1px; border-right-style:1px" rowspan="2">EMPLOYEE COMMENTS <br>'.$row['comments4'].'</td>
					</tr>
					<tr>
						<td width="3%" style="border-bottom-style:1px; border-left-style:1px"></td>
					...
					<tr>
						...
						<td width="46%" style="border-bottom-style:1px; border-right-style:1px" rowspan="2">EMPLOYEE COMMENTS <br>'.$row['comments5'].'</td>
					</tr>
					<tr>
						<td width="3%" style="border-bottom-style:1px; border-left-style:1px"></td>
					...
					<tr>
						...
						<td width="46%" style="border-bottom-style:1px; border-right-style:1px" rowspan="2">EMPLOYEE COMMENTS <br>'.$row['comments6'].'</td>
					</tr>
					<tr>
						<td width="3%" style="border-bottom-style:1px; border-left-style:1px"></td>
			...
			$tbl6 .= '<tr>
					...
					<tr>
						<td align="center" colspan="2"><b>FOR HR REFERENCE ONLY</b></td>
					</tr>
					<tr>
						<td colspan="2" style="border-left-style:1px; border-right-style:1px; border-top-style:1px;"><b>Performance Recommendation</b></td>
					</tr>
					<tr>
						<td width="10%" style="border-left-style:1px;"></td>
						<td width="35%"><input type="checkbox" name="rec1" value="For Regularization"'.(in_array("For Regularization",$data1) ? ' checked="checked" ' : '') .'>For Regularization</td>
						<td width="55%" style="border-right-style:1px;"><input type="checkbox" name="rec1" value="End of Employment"'.(in_array("End of Employment",$data1) ? ' checked="checked" ' : '') .'>End of Employment</td>
					</tr>
					<tr>
						<td width="10%" style="border-left-style:1px;"></td>
						<td width="35%"><input type="checkbox" name="rec1" value="For Promotion"'.(in_array("For Promotion",$data1) ? ' checked="checked" ' : '') .'>For Promotion</td>
						<td width="55%" style="border-right-style:1px;"><input type="checkbox" name="rec1" value="Transfer Department / Unit / Project"'.(in_array("Transfer Department / Unit / Project",$data1) ? ' checked="checked" ' : '') .'>Transfer Department / Unit / Project</td>
					</tr>
					<tr>
						<td width="10%" style="border-left-style:1px; border-bottom-style:1px;"></td>
						<td width="35%" style="border-bottom-style:1px;"><input type="checkbox" name="rec1" value="For Salary Adjustment"'.(in_array("For Salary Adjustment",$data1) ? ' checked="checked" ' : '') .'>For Salary Adjustment</td>
						<td width="55%" style="border-right-style:1px; border-bottom-style:1px;">&nbsp;&nbsp;&nbsp;Recommended monthly gross pay: <b><u>'.$row['gross'].'</u></b></td>
					</tr>';
		}
	}
	else//evaluated PAR
	{
		$par->par_id = $_GET['id'];//sup_id from par_details
		...
		while($row = $get->fetch(PDO::FETCH_ASSOC))
		{
			...
			$tbl1 .= '<tr>
					...
					<tr>
						<td style="border: 1px solid black">Unit/Project Assigned</td>
						<td style="border: 1px solid black">'.$row['unit_name'].'</td>
						<td style="border: 1px solid black">Performance Assessment</td>
						<td style="border: 1px solid black">'.$row['assessment'].'</td>
					</tr>
					<tr>
