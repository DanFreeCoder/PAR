            ...
            <div class="box">
                <div class="content">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#draftTabPanel" role="tab"><span class="fa fa-edit"></span> Draft PAR</a> </li>
                        ...
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#approvedTabPanel" role="tab"><span class="fa fa-check"></span> Approved PAR</a> </li>
                    </ul>
                    <!-- DRAFT PAR TAB PANEL -->
                    <div class="tab-content tabcontent-border">
                        <div class="tab-pane active" id="draftTabPanel" role="tabpanel"><br>
                            ...
                            <div class="table-responsive">
                                <table id="evalTable" class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        while ($row1 = $view->fetch(PDO::FETCH_ASSOC)) {
                                            $action = '<center><a href="#" class="print-par" value="' . $row1['id'] . '"><i class="fa fa-print"></i> Print PAR</a></center>';
                                            $date = date('F j, Y', strtotime($row1['date_submit']));
                                            echo '
                                                    <tr>
                                ...
                                <table id="approvedTable" class="table table-bordered">
                                    <thead>
                                        <tr>
                                            <th style="width: 15%">Employee Name</th>
                                            <th style="text-align: center; width: 10%">Department</th>
                                            <th style="text-align: center; width: 10%">Date Approved</th>
                                            <th style="text-align: center; width: 15%">Reviewed by</th>
                                            <th style="text-align: center; width: 15%">Action</th>
                                    ...
                                    <tbody>
                                        <?php
                                        $user->emp_name = $_SESSION['fullname'];
                                        $get = $user->approved_PAR_tbl_emp();
                                        while ($row = $get->fetch(PDO::FETCH_ASSOC)) {
                                            $emp_name = $row['emp_name'];
                                            $dept_name = $row['dept_name'];
                                            $date_approved = date('F j, Y', strtotime($row['date_approved']));
                                            $review_by = $row['approved_by'];
                                            echo '
                                            <tr>
                                                <td>' . $emp_name . '</td>
                                                <td>' . $dept_name . '</td>
                                                <td>' . $date_approved . '</td>
                                                <td>' . $review_by . '</td>
                                                <td><a href="#" class="print-approved_par" value="' . $row['id'] . '"><i class="fa fa-print"></i> Print Approved PAR</a></td>
                                            </tr>
                                            ';
                                        }
                                        ?>
