...
<body id="page-top" class="subpage">
	...
	while ($row1 = $sel->fetch(PDO::FETCH_ASSOC)) {
		...
		if ($from == 'January 1, 1970') {
			$from = date('F j, Y');
		}
		if ($to == 'January 1, 1970') {
			$to = date('F j, Y');
		}
		//kra_kpi
		$kra1 = $row1['kra1'];
					...
					<form method="post" action="#">
						<div class="row uniform">
							<div class="3u 12u$(xsmall)">
								...
								<input type="text" id="id" value="<?php echo $par_id; ?>" style="display: none">
								<input type="text" id="kra-id" value="<?php echo $kra_id; ?>" style="display: none">
								<input type="text" id="gp-id" value="<?php echo $gp_id; ?>" style="display: none">
								<input type="text" id="pip-id" value="<?php echo $pip_id; ?>" style="display: none">
								<input type="text" id="emp-id" value="<?php echo $emp_id; ?>" style="display: none">
							...
							<div class="3u 12u$(xsmall)">
								<select id="status">
									<option value="0" <?php echo ($emp_status == '-Select Employment Status-') ? 'selected' : ''; ?>>-Select Employment Status-</option>
									<option value="1" <?php echo ($emp_status == 'Regular') ? 'selected' : ''; ?>>Regular</option>
									<option value="2" <?php echo ($emp_status == 'Probationary') ? 'selected' : ''; ?>>Probationary</option>
									<option value="3" <?php echo ($emp_status == 'Project Based') ? 'selected' : ''; ?>>Project Based</option>
									<option value="4" <?php echo ($emp_status == 'Casual') ? 'selected' : ''; ?>>Casual</option>
									<option value="5" <?php echo ($emp_status == 'Trainee') ? 'selected' : ''; ?>>Trainee</option>
									<option value="6" <?php echo ($emp_status == 'Others') ? 'selected' : ''; ?>>Others</option>
								</select>
							</div>
							<div class="3u 12u$(xsmall)">
								<select id="assessment">
									<option value="0" <?php echo ($assessment == '-Performance Assessment-' ? 'selected' : '') ?>>-Performance Assessment-</option>
									<option value="1" <?php echo ($assessment == 'Annual' ? 'selected' : '') ?>>Annual</option>
									<option value="7" <?php echo ($assessment == 'Mid Year' ? 'selected' : '') ?>>Mid Year</option>
									<option value="2" <?php echo ($assessment == '5th Month' ? 'selected' : '') ?>>5th Month</option>
									<option value="3" <?php echo ($assessment == '3rd Month' ? 'selected' : '') ?>>3rd Month</option>
									<option value="5" <?php echo ($assessment == 'Training' ? 'selected' : '') ?>>Training</option>
									<option value="6" <?php echo ($assessment == 'Others' ? 'selected' : '') ?>>Others</option>
								</select>
							</div>
							<div class="3u 12u$(xsmall)" id="years">
								<select id="year" style="color: black;" class="form-group">
									<?php
									echo '<option value="' . $from . '" selected disabled>' . $from . '</option>';
									$start_year = 2022;
							...
							<div class="3u 12u$(xsmall)">
								<select id="rater">
									<option value="0" <?php echo ($rater == 0 || $rater == '- First Approver -') ? 'selected' : ''; ?> disabled>- First Approver -</option>
									<option value="2" <?php echo ($rater == 2 || $rater == 'Immediate Superior') ? 'selected' : ''; ?>>Immediate Superior</option>
									<option value="3" <?php echo ($rater == 3 || $rater == 'Manager') ? 'selected' : ''; ?>>Manager</option>
									<option value="4" <?php echo ($rater == 4 || $rater == 'Sr. Manager') ? 'selected' : ''; ?>>Sr. Manager</option>
			...
			<div class="box">
				<div class="content">
					...
					<div class="row">
						...
						<div id="kra1-checkbox" class="row">
							<div class="col-sm-2">
								...
								<span class="checkbox-kra1">
									<input type="checkbox" id="kra1-5" value="5" <?php echo ($rate1 == '5') ? 'checked' : ''; ?>>
							...
							<div class="col-sm-2">
								<br><br>
								<span class="checkbox-kra1">
									<input type="checkbox" id="kra1-4" value="4" <?php echo ($rate1 == '4') ? 'checked' : ''; ?>>
							...
							<div class="col-sm-2">
								<br><br>
								<span class="checkbox-kra1">
									<input type="checkbox" id="kra1-3" value="3" <?php echo ($rate1 == '3') ? 'checked' : ''; ?>>
							...
							<div class="col-sm-2">
								<b>RATING</b><br><br>
								<span class="checkbox-kra1">
									<input type="checkbox" id="kra1-2" value="2" <?php echo ($rate1 == '2') ? 'checked' : ''; ?>>
							...
							<div class="col-sm-2">
								<br><br>
								<span class="checkbox-kra1">
									<input type="checkbox" id="kra1-1" value="1" <?php echo ($rate1 == '1') ? 'checked' : ''; ?>>
							...
							<div class="col-sm-2">
								<br><br>
								<span class="checkbox-kra1">
									<input type="checkbox" id="kra1-na" value="0" <?php echo ($rate1 == '0') ? 'checked' : ''; ?>>
						...
						<div class="col-sm-6">
							COMMENTS
							<textarea name="message" id="comments1" placeholder="Enter comments here" rows="3"><?php echo $comments1; ?></textarea>
					...
					<div class="row">
						...
						<div class="col-sm-6">
							COMMENTS
							<textarea name="message" id="comments2" placeholder="Enter comments here" rows="3"><?php echo $comments2; ?></textarea>
					...
					<div class="row">
						...
						<div class="col-sm-6">
							COMMENTS
							<textarea name="message" id="comments3" placeholder="Enter comments here" rows="3"><?php echo $comments3; ?></textarea>
					...
					<div class="row">
						...
						<div class="col-sm-6">
							COMMENTS
							<textarea name="message" id="comments4" placeholder="Enter comments here" rows="3"><?php echo $comments4; ?></textarea>
					...
					<div class="row">
						...
						<div class="col-sm-6">
							COMMENTS
							<textarea name="message" id="comments5" placeholder="Enter comments here" rows="3"><?php echo $comments5; ?></textarea>
					...
					<div class="row">
						...
						<div class="col-sm-6">
							COMMENTS
							<textarea name="message" id="comments6" placeholder="Enter comments here" rows="3"><?php echo $comments6; ?></textarea>
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div id="gp2b" class="row">
								...
								<div class="col-sm-3">
									<textarea id="gp2b-comment" placeholder="Enter comments here" rows="4"><?php echo $gp2b_comment; ?></textarea>
					...
					<div class="comments">
						...
						<div class="col-md-12"><textarea id="emp-comments" placeholder="Enter comments here" rows="2"><?php echo $emp_comment; ?></textarea>
	...
	<?php include 'js/draft_par-js.php'; ?>
