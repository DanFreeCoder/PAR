						...
						<div class="row uniform">
							...
							<div class="3u 12u$(xsmall)">
								<select id="assessment" disabled>
									<?php
									if ($assessment == 'Annual' || $assessment == 1) {
										echo '<option value="0">-Performance Assessment-</option>
														  ...
														  <option value="6">Others</option>';
									} elseif ($assessment == '5th Month' || $assessment == 2) {
										echo '<option value="0">-Performance Assessment-</option>
														  ...
														  <option value="5">Training</option>
														  <option value="6">Others</option>';
									} elseif ($assessment == '3rd Month' || $assessment == 3) {
										echo '<option value="0">-Performance Assessment-</option>
														  <option value="1">Annual</option>
														  <option value="7">Mid Year</option>
														  <option value="2">5th Month</option>
														  ...
														  <option value="5">Training</option>
														  <option value="6">Others</option>';
									} elseif ($assessment == '2nd Month' || $assessment == 4) {
										echo '<option value="0">-Performance Assessment-</option>
														  <option value="1">Annual</option>
														  <option value="7">Mid Year</option>
														  <option value="2">5th Month</option>
														  ...
														  <option value="5">Training</option>
														  <option value="6">Others</option>';
									} elseif ($assessment == 'Training' || $assessment == 5) {
										echo '<option value="0">-Performance Assessment-</option>
														  <option value="1">Annual</option>
														  <option value="7">Mid Year</option>
														  <option value="2">5th Month</option>
														  ...
														  <option value="6">Others</option>';
									} elseif ($assessment == 'Others' || $assessment == 6) {
										echo '<option value="0">-Performance Assessment-</option>
														  <option value="1">Annual</option>
														  <option value="7">Mid Year</option>
														  <option value="2">5th Month</option>
														  ...
														  <option value="5">Training</option>
														  <option value="6" selected>Others</option>';
									} elseif ($assessment == 'Mid Year' || $assessment == 7) {
										echo '<option value="0">-Performance Assessment-</option>
														  <option value="1">Annual</option>
