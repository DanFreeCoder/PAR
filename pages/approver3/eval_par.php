				...
				<div class="content">
					...
					<form method="post" action="#">
						<div class="row uniform">
							...
							<!-- Break -->
							<div class="3u 12u$(xsmall)">
								<input type="text" id="status" value="<?php echo $emp_status; ?>" disabled />
							</div>
							<div class="3u 12u$(xsmall)">
								<input type="text" id="assessment" value="<?php echo $assessment; ?>" disabled />
							</div>
							<div class="3u 12u$(xsmall)">
		...
		<div class="inner">
			<div class="box">
				<div class="content">
					...
					<div class="row">
						<div class="col-sm-6">
							<textarea name="message" id="kra1" class="kra-input" placeholder="KRA here" rows="4"><?php echo $kra1; ?></textarea>
						</div>
						<div id="kra1-checkbox" class="row">
							<div class="col-sm-2">
								...
								<span class="checkbox-kra1">
									<?php
									if ($rate1 == '5') {
										echo '<input type="checkbox" id="kra1-5" class="kra-input" value="5" checked>';
									} else {
										echo '<input type="checkbox" id="kra1-5" class="kra-input" value="5" >';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra1">
									<?php
									if ($rate1 == '4') {
										echo '<input type="checkbox" id="kra1-4" class="kra-input" value="4" checked>';
									} else {
										echo '<input type="checkbox" id="kra1-4" class="kra-input" value="4" >';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra1">
									<?php
									if ($rate1 == '3') {
										echo '<input type="checkbox" id="kra1-3" class="kra-input" value="3" checked>';
									} else {
										echo '<input type="checkbox" id="kra1-3" class="kra-input" value="3" >';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra1">
									<?php
									if ($rate1 == '2') {
										echo '<input type="checkbox" id="kra1-2" class="kra-input" value="2" checked>';
									} else {
										echo '<input type="checkbox" id="kra1-2" class="kra-input" value="2">';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra1">
									<?php
									if ($rate1 == '1') {
										echo '<input type="checkbox" id="kra1-1" class="kra-input" value="1" checked>';
									} else {
										echo '<input type="checkbox" id="kra1-1" class="kra-input" value="1" >';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra1">
									...
									if ($rate1 == '0' || $rate1 == null) {
										echo '<input type="checkbox" id="kra1-na" class="kra-input" value="0" checked>';
									} else {
										echo '<input type="checkbox" id="kra1-na" class="kra-input" value="0">';
									}
									?>
						...
						<div class="col-sm-6">
							<textarea name="message" id="kpi1" class="kra-input" placeholder="Enter KPI's here" rows="4"><?php echo $kpi1; ?></textarea>
						</div>
						<div class="col-sm-3">
							<textarea name="message" id="comments1" class="kra-input" placeholder="Enter comments here" rows="4" disabled><?php echo $comments1; ?></textarea>
						</div>
						<div class="col-sm-3">
					...
					<div class="row">
						<div class="col-sm-6">
							<textarea name="message" id="kra2" class="kra-input" placeholder="KRA here" rows="4"><?php echo $kra2; ?></textarea>
						</div>
						<div id="kra2-checkbox" class="row">
							<div class="col-sm-2">
								...
								<span class="checkbox-kra2">
									<?php
									if ($rate2 == '5') {
										echo '<input type="checkbox" id="kra2-5" class="kra-input" value="5" checked>';
									} else {
										echo '<input type="checkbox" id="kra2-5" class="kra-input" value="5">';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra2">
									<?php
									if ($rate2 == '4') {
										echo '<input type="checkbox" id="kra2-4" class="kra-input" value="4" checked>';
									} else {
										echo '<input type="checkbox" id="kra2-4" class="kra-input" value="4">';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra2">
									<?php
									if ($rate2 == '3') {
										echo '<input type="checkbox" id="kra2-3" class="kra-input" value="3" checked>';
									} else {
										echo '<input type="checkbox" id="kra2-3" class="kra-input" value="3">';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra2">
									<?php
									if ($rate2 == '2') {
										echo '<input type="checkbox" id="kra2-2" class="kra-input" value="2" checked>';
									} else {
										echo '<input type="checkbox" id="kra2-2" class="kra-input" value="2">';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra2">
									<?php
									if ($rate2 == '1') {
										echo '<input type="checkbox" id="kra2-1" class="kra-input" value="1" checked>';
									} else {
										echo '<input type="checkbox" id="kra2-1" class="kra-input" value="1">';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra2">
									...
									if ($rate2 == '0' || $rate2 == null) {
										echo '<input type="checkbox" id="kra2-na" class="kra-input" value="0" checked>';
									} else {
										echo '<input type="checkbox" id="kra2-na" class="kra-input" value="0">';
									}
									?>
						...
						<div class="col-sm-6">
							<textarea name="message" id="kpi2" class="kra-input" placeholder="Enter KPI's here" rows="4"><?php echo $kpi2; ?></textarea>
						</div>
						<div class="col-sm-3">
							<textarea name="message" id="comments2" class="kra-input" placeholder="Enter comments here" rows="4" disabled><?php echo $comments2; ?></textarea>
						</div>
						<div class="col-sm-3">
					...
					<div class="row">
						<div class="col-sm-6">
							<textarea name="message" id="kra3" class="kra-input" placeholder="KRA here" rows="4"><?php echo $kra3; ?></textarea>
						</div>
						<div id="kra3-checkbox" class="row">
							<div class="col-sm-2">
								...
								<span class="checkbox-kra3">
									<?php
									if ($rate3 == '5') {
										echo '<input type="checkbox" id="kra3-5" class="kra-input" value="5" checked>';
									} else {
										echo '<input type="checkbox" id="kra3-5" class="kra-input" value="5">';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra3">
									<?php
									if ($rate3 == '4') {
										echo '<input type="checkbox" id="kra3-4" class="kra-input" value="4" checked>';
									} else {
										echo '<input type="checkbox" id="kra3-4" class="kra-input" value="4">';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra3">
									<?php
									if ($rate3 == '3') {
										echo '<input type="checkbox" id="kra3-3" class="kra-input" value="3" checked>';
									} else {
										echo '<input type="checkbox" id="kra3-3" class="kra-input" value="3">';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra3">
									<?php
									if ($rate3 == '2') {
										echo '<input type="checkbox" id="kra3-2" class="kra-input" value="2" checked>';
									} else {
										echo '<input type="checkbox" id="kra3-2" class="kra-input" value="2">';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra3">
									<?php
									if ($rate3 == '1') {
										echo '<input type="checkbox" id="kra3-1" class="kra-input" value="1" checked>';
									} else {
										echo '<input type="checkbox" id="kra3-1" class="kra-input" value="1">';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra3">
									...
									if ($rate3 == '0' || $rate3 == null) {
										echo '<input type="checkbox" id="kra3-na" class="kra-input" value="0" checked>';
									} else {
										echo '<input type="checkbox" id="kra3-na" class="kra-input" value="0">';
									}
									?>
						...
						<div class="col-sm-6">
							<textarea name="message" id="kpi3" class="kra-input" placeholder="Enter KPI's here" rows="4"><?php echo $kpi3; ?></textarea>
						</div>
						<div class="col-sm-3">
							<textarea name="message" id="comments3" class="kra-input" placeholder="Enter comments here" rows="4" disabled><?php echo $comments3; ?></textarea>
						</div>
						<div class="col-sm-3">
					...
					<div class="row">
						<div class="col-sm-6">
							<textarea name="message" id="kra4" class="kra-input" placeholder="KRA here" rows="4"><?php echo $kra4; ?></textarea>
						</div>
						<div id="kra4-checkbox" class="row">
							<div class="col-sm-2">
								...
								<span class="checkbox-kra4">
									<?php
									if ($rate4 == '5') {
										echo '<input type="checkbox" id="kra4-5" class="kra-input" value="5" checked>';
									} else {
										echo '<input type="checkbox" id="kra4-5" class="kra-input" value="5">';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra4">
									<?php
									if ($rate4 == '4') {
										echo '<input type="checkbox" id="kra4-4" class="kra-input" value="4" checked>';
									} else {
										echo '<input type="checkbox" id="kra4-4" class="kra-input" value="4">';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra4">
									<?php
									if ($rate4 == '3') {
										echo '<input type="checkbox" id="kra4-3" class="kra-input" value="3" checked>';
									} else {
										echo '<input type="checkbox" id="kra4-3" class="kra-input" value="3">';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra4">
									<?php
									if ($rate4 == '2') {
										echo '<input type="checkbox" id="kra4-2" class="kra-input" value="2" checked>';
									} else {
										echo '<input type="checkbox" id="kra4-2" class="kra-input" value="2">';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra4">
									<?php
									if ($rate4 == '1') {
										echo '<input type="checkbox" id="kra4-1" class="kra-input" value="1" checked>';
									} else {
										echo '<input type="checkbox" id="kra4-1" class="kra-input" value="1">';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra4">
									...
									if ($rate4 == '0' || $rate4 == null) {
										echo '<input type="checkbox" id="kra4-na" class="kra-input" value="0" checked>';
									} else {
										echo '<input type="checkbox" id="kra4-na" class="kra-input" value="0">';
									}
									?>
						...
						<div class="col-sm-6">
							<textarea name="message" id="kpi4" class="kra-input" placeholder="Enter KPI's here" rows="4"><?php echo $kpi4; ?></textarea>
						</div>
						<div class="col-sm-3">
							<textarea name="message" id="comments4" class="kra-input" placeholder="Enter comments here" rows="4" disabled><?php echo $comments4; ?></textarea>
						</div>
						<div class="col-sm-3">
					...
					<div class="row">
						<div class="col-sm-6">
							<textarea name="message" id="kra5" class="kra-input" placeholder="KRA here" rows="4"><?php echo $kra5; ?></textarea>
						</div>
						<div id="kra5-checkbox" class="row">
							<div class="col-sm-2">
								...
								<span class="checkbox-kra5">
									<?php
									if ($rate5 == '5') {
										echo '<input type="checkbox" id="kra5-5" class="kra-input" value="5" checked>';
									} else {
										echo '<input type="checkbox" id="kra5-5" class="kra-input" value="5">';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra5">
									<?php
									if ($rate5 == '4') {
										echo '<input type="checkbox" id="kra5-4" class="kra-input" value="4" checked>';
									} else {
										echo '<input type="checkbox" id="kra5-4" class="kra-input" value="4">';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra5">
									<?php
									if ($rate5 == '3') {
										echo '<input type="checkbox" id="kra5-3" class="kra-input" value="3" checked>';
									} else {
										echo '<input type="checkbox" id="kra5-3" class="kra-input" value="3">';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra5">
									<?php
									if ($rate5 == '2') {
										echo '<input type="checkbox" id="kra5-2" class="kra-input" value="2" checked>';
									} else {
										echo '<input type="checkbox" id="kra5-2" class="kra-input" value="2">';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra5">
									<?php
									if ($rate5 == '1') {
										echo '<input type="checkbox" id="kra5-1" class="kra-input" value="1" checked>';
									} else {
										echo '<input type="checkbox" id="kra5-1" class="kra-input" value="1">';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra5">
									...
									if ($rate5 == '0' || $rate5 == null) {
										echo '<input type="checkbox" id="kra5-na" class="kra-input" value="0" checked>';
									} else {
										echo '<input type="checkbox" id="kra5-na" class="kra-input" value="0">';
									}
									?>
						...
						<div class="col-sm-6">
							<textarea name="message" id="kpi5" class="kra-input" placeholder="Enter KPI's here" rows="4"><?php echo $kpi5; ?></textarea>
						</div>
						<div class="col-sm-3">
							<textarea name="message" id="comments5" class="kra-input" placeholder="Enter comments here" rows="4" disabled><?php echo $comments5; ?></textarea>
						</div>
						<div class="col-sm-3">
					...
					<div class="row">
						<div class="col-sm-6">
							<textarea name="message" id="kra6" class="kra-input" placeholder="KRA here" rows="4"><?php echo $kra6; ?></textarea>
						</div>
						<div id="kra6-checkbox" class="row">
							<div class="col-sm-2">
								...
								<span class="checkbox-kra6">
									<?php
									if ($rate6 == '5') {
										echo '<input type="checkbox" id="kra6-5" class="kra-input" value="5" checked>';
									} else {
										echo '<input type="checkbox" id="kra6-5" class="kra-input" value="5">';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra6">
									<?php
									if ($rate6 == '4') {
										echo '<input type="checkbox" id="kra6-4" class="kra-input" value="4" checked>';
									} else {
										echo '<input type="checkbox" id="kra6-4" class="kra-input" value="4">';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra6">
									<?php
									if ($rate6 == '3') {
										echo '<input type="checkbox" id="kra6-3" class="kra-input" value="3" checked>';
									} else {
										echo '<input type="checkbox" id="kra6-3" class="kra-input" value="3">';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra6">
									<?php
									if ($rate6 == '2') {
										echo '<input type="checkbox" id="kra6-2" class="kra-input" value="2" checked>';
									} else {
										echo '<input type="checkbox" id="kra6-2" class="kra-input" value="2">';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra6">
									<?php
									if ($rate6 == '1') {
										echo '<input type="checkbox" id="kra6-1" class="kra-input" value="1" checked>';
									} else {
										echo '<input type="checkbox" id="kra6-1" class="kra-input" value="1">';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra6">
									...
									if ($rate6 == '0' || $rate6 == null) {
										echo '<input type="checkbox" id="kra6-na" class="kra-input" value="0" checked>';
									} else {
										echo '<input type="checkbox" id="kra6-na" class="kra-input" value="0">';
									}
									?>
						...
						<div class="col-sm-6">
							<textarea name="message" id="kpi6" class="kra-input" placeholder="Enter KPI's here" rows="4"><?php echo $kpi6; ?></textarea>
						</div>
						<div class="col-sm-3">
							<textarea name="message" id="comments6" class="kra-input" placeholder="Enter comments here" rows="4" disabled><?php echo $comments6; ?></textarea>
						</div>
						<div class="col-sm-3">
					...
					<div class="Accomplishments">
						<div class="row">
							...
							<div class="col-sm-12">
								<textarea id="accomplishments" placeholder="Enter details here" rows="4" disabled><?php echo $accomplishment; ?></textarea>
