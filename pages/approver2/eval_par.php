...
<body id="page-top" class="subpage">
	...
	$sel = $details->get_evaluated_par_details();
		...
		<div class="inner">
			<div class="box">
				<div class="content">
					...
					<div class="row">
						<div class="col-sm-6">
							<textarea name="message" id="kra1" placeholder="KRA here" rows="4" disabled><?php echo $kra1; ?></textarea>
						</div>
						<div id="kra1-checkbox" class="row checkbox-kra">
							<div class="col-sm-2">
								<br><br>
								<span class="checkbox-kra1">
									<?php
									if ($rate1 == '5') {
										echo '<input type="checkbox" id="kra1-5" value="5" checked disabled>';
									} else {
										echo '<input type="checkbox" id="kra1-5" value="5" disabled>';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra1">
									<?php
									if ($rate1 == '4') {
										echo '<input type="checkbox" id="kra1-4" value="4" checked disabled>';
									} else {
										echo '<input type="checkbox" id="kra1-4" value="4" disabled>';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra1">
									<?php
									if ($rate1 == '3') {
										echo '<input type="checkbox" id="kra1-3" value="3" checked disabled>';
									} else {
										echo '<input type="checkbox" id="kra1-3" value="3" disabled>';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra1">
									<?php
									if ($rate1 == '2') {
										echo '<input type="checkbox" id="kra1-2" value="2" checked disabled>';
									} else {
										echo '<input type="checkbox" id="kra1-2" value="2" disabled>';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra1">
									<?php
									if ($rate1 == '1') {
										echo '<input type="checkbox" id="kra1-1" value="1" checked disabled>';
									} else {
										echo '<input type="checkbox" id="kra1-1" value="1" disabled>';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra1">
									...
									if ($rate1 == '0' || $rate1 == null) {
										echo '<input type="checkbox" id="kra1-na" value="0" checked disabled>';
									} else {
										echo '<input type="checkbox" id="kra1-na" value="0" disabled>';
									}
									?>
						...
						<div class="col-sm-6">
							<textarea name="message" id="kpi1" placeholder="Enter KPI's here" rows="4" disabled><?php echo $kpi1; ?></textarea>
						</div>
						<div class="col-sm-3">
							<textarea name="message" id="comments1" placeholder="Enter comments here" rows="4" disabled><?php echo $comments1; ?></textarea>
						</div>
						<div class="col-sm-3">
							<textarea name="message" id="sup-comment1" placeholder="Supervisor's comments here" rows="4" disabled><?php echo $sup_com1; ?></textarea>
						</div>
					</div>
					<!-- B -->
					<h4><b>B.</b></h4>
					<div class="row">
						<div class="col-sm-6">
							<textarea name="message" id="kra2" placeholder="KRA here" rows="4" disabled><?php echo $kra2; ?></textarea>
						</div>
						<div id="kra2-checkbox" class="row">
							<div class="col-sm-2">
								...
								<span class="checkbox-kra2">
									<?php
									if ($rate2 == '5') {
										echo '<input type="checkbox" id="kra2-5" value="5" checked disabled>';
									} else {
										echo '<input type="checkbox" id="kra2-5" value="5" disabled>';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra2">
									<?php
									if ($rate2 == '4') {
										echo '<input type="checkbox" id="kra2-4" value="4" checked disabled>';
									} else {
										echo '<input type="checkbox" id="kra2-4" value="4" disabled>';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra2">
									<?php
									if ($rate2 == '3') {
										echo '<input type="checkbox" id="kra2-3" value="3" checked disabled>';
									} else {
										echo '<input type="checkbox" id="kra2-3" value="3" disabled>';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra2">
									<?php
									if ($rate2 == '2') {
										echo '<input type="checkbox" id="kra2-2" value="2" checked disabled>';
									} else {
										echo '<input type="checkbox" id="kra2-2" value="2" disabled>';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra2">
									<?php
									if ($rate2 == '1') {
										echo '<input type="checkbox" id="kra2-1" value="1" checked disabled>';
									} else {
										echo '<input type="checkbox" id="kra2-1" value="1" disabled>';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra2">
									...
									if ($rate2 == '0' || $rate2 == null) {
										echo '<input type="checkbox" id="kra2-na" value="0" checked disabled>';
									} else {
										echo '<input type="checkbox" id="kra2-na" value="0" disabled>';
									}
									?>
						...
						<div class="col-sm-6">
							<textarea name="message" id="kpi2" placeholder="Enter KPI's here" rows="4" disabled><?php echo $kpi2; ?></textarea>
						</div>
						<div class="col-sm-3">
							<textarea name="message" id="comments2" placeholder="Enter comments here" rows="4" disabled><?php echo $comments2; ?></textarea>
						</div>
						<div class="col-sm-3">
							<textarea name="message" id="sup-comment2" placeholder="Supervisor's comments here" rows="4" disabled><?php echo $sup_com2; ?></textarea>
						</div>
					</div>
					<!-- C -->
					<h4><b>C.</b></h4>
					<div class="row">
						<div class="col-sm-6">
							<textarea name="message" id="kra3" placeholder="KRA here" rows="4" disabled><?php echo $kra3; ?></textarea>
						</div>
						<div id="kra3-checkbox" class="row">
							<div class="col-sm-2">
								...
								<span class="checkbox-kra3">
									<?php
									if ($rate3 == '5') {
										echo '<input type="checkbox" id="kra3-5" value="5" checked disabled>';
									} else {
										echo '<input type="checkbox" id="kra3-5" value="5" disabled>';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra3">
									<?php
									if ($rate3 == '4') {
										echo '<input type="checkbox" id="kra3-4" value="4" checked disabled>';
									} else {
										echo '<input type="checkbox" id="kra3-4" value="4" disabled>';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra3">
									<?php
									if ($rate3 == '3') {
										echo '<input type="checkbox" id="kra3-3" value="3" checked disabled>';
									} else {
										echo '<input type="checkbox" id="kra3-3" value="3" disabled>';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra3">
									<?php
									if ($rate3 == '2') {
										echo '<input type="checkbox" id="kra3-2" value="2" checked disabled>';
									} else {
										echo '<input type="checkbox" id="kra3-2" value="2" disabled>';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra3">
									<?php
									if ($rate3 == '1') {
										echo '<input type="checkbox" id="kra3-1" value="1" checked disabled>';
									} else {
										echo '<input type="checkbox" id="kra3-1" value="1" disabled>';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra3">
									...
									if ($rate3 == '0' || $rate3 == null) {
										echo '<input type="checkbox" id="kra3-na" value="0" checked disabled>';
									} else {
										echo '<input type="checkbox" id="kra3-na" value="0" disabled>';
									}
									?>
						...
						<div class="col-sm-6">
							<textarea name="message" id="kpi3" placeholder="Enter KPI's here" rows="4" disabled><?php echo $kpi3; ?></textarea>
						</div>
						<div class="col-sm-3">
							<textarea name="message" id="comments3" placeholder="Enter comments here" rows="4" disabled><?php echo $comments3; ?></textarea>
						</div>
						<div class="col-sm-3">
							<textarea name="message" id="sup-comment3" placeholder="Supervisor's comments here" rows="4" disabled><?php echo $sup_com3; ?></textarea>
						</div>
					</div>
					<!-- D -->
					<h4><b>D.</b></h4>
					<div class="row">
						<div class="col-sm-6">
							<textarea name="message" id="kra4" placeholder="KRA here" rows="4" disabled><?php echo $kra4; ?></textarea>
						</div>
						<div id="kra4-checkbox" class="row">
							<div class="col-sm-2">
								...
								<span class="checkbox-kra4">
									<?php
									if ($rate4 == '5') {
										echo '<input type="checkbox" id="kra4-5" value="5" checked disabled>';
									} else {
										echo '<input type="checkbox" id="kra4-5" value="5" disabled>';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra4">
									<?php
									if ($rate4 == '4') {
										echo '<input type="checkbox" id="kra4-4" value="4" checked disabled>';
									} else {
										echo '<input type="checkbox" id="kra4-4" value="4" disabled>';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra4">
									<?php
									if ($rate4 == '3') {
										echo '<input type="checkbox" id="kra4-3" value="3" checked disabled>';
									} else {
										echo '<input type="checkbox" id="kra4-3" value="3" disabled>';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra4">
									<?php
									if ($rate4 == '2') {
										echo '<input type="checkbox" id="kra4-2" value="2" checked disabled>';
									} else {
										echo '<input type="checkbox" id="kra4-2" value="2" disabled>';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra4">
									<?php
									if ($rate4 == '1') {
										echo '<input type="checkbox" id="kra4-1" value="1" checked disabled>';
									} else {
										echo '<input type="checkbox" id="kra4-1" value="1" disabled>';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra4">
									...
									if ($rate4 == '0' || $rate4 == null) {
										echo '<input type="checkbox" id="kra4-na" value="0" checked disabled>';
									} else {
										echo '<input type="checkbox" id="kra4-na" value="0" disabled>';
									}
									?>
						...
						<div class="col-sm-6">
							<textarea name="message" id="kpi4" placeholder="Enter KPI's here" rows="4" disabled><?php echo $kpi4; ?></textarea>
						</div>
						<div class="col-sm-3">
							<textarea name="message" id="comments4" placeholder="Enter comments here" rows="4" disabled><?php echo $comments4; ?></textarea>
						</div>
						<div class="col-sm-3">
							<textarea name="message" id="sup-comment4" placeholder="Supervisor's comments here" rows="4" disabled><?php echo $sup_com4; ?></textarea>
						</div>
					</div>
					<!-- E -->
					<h4><b>E.</b></h4>
					<div class="row">
						<div class="col-sm-6">
							<textarea name="message" id="kra5" placeholder="KRA here" rows="4" disabled><?php echo $kra5; ?></textarea>
						</div>
						<div id="kra5-checkbox" class="row">
							<div class="col-sm-2">
								...
								<span class="checkbox-kra5">
									<?php
									if ($rate5 == '5') {
										echo '<input type="checkbox" id="kra5-5" value="5" checked disabled>';
									} else {
										echo '<input type="checkbox" id="kra5-5" value="5" disabled>';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra5">
									<?php
									if ($rate5 == '4') {
										echo '<input type="checkbox" id="kra5-4" value="4" checked disabled>';
									} else {
										echo '<input type="checkbox" id="kra5-4" value="4" disabled>';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra5">
									<?php
									if ($rate5 == '3') {
										echo '<input type="checkbox" id="kra5-3" value="3" checked disabled>';
									} else {
										echo '<input type="checkbox" id="kra5-3" value="3" disabled>';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra5">
									<?php
									if ($rate5 == '2') {
										echo '<input type="checkbox" id="kra5-2" value="2" checked disabled>';
									} else {
										echo '<input type="checkbox" id="kra5-2" value="2" disabled>';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra5">
									<?php
									if ($rate5 == '1') {
										echo '<input type="checkbox" id="kra5-1" value="1" checked disabled>';
									} else {
										echo '<input type="checkbox" id="kra5-1" value="1" disabled>';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra5">
									...
									if ($rate5 == '0' || $rate5 == null) {
										echo '<input type="checkbox" id="kra5-na" value="0" checked disabled>';
									} else {
										echo '<input type="checkbox" id="kra5-na" value="0" disabled>';
									}
									?>
						...
						<div class="col-sm-6">
							<textarea name="message" id="kpi5" placeholder="Enter KPI's here" rows="4" disabled><?php echo $kpi5; ?></textarea>
						</div>
						<div class="col-sm-3">
							<textarea name="message" id="comments5" placeholder="Enter comments here" rows="4" disabled><?php echo $comments5; ?></textarea>
						</div>
						<div class="col-sm-3">
							<textarea name="message" id="sup-comment5" placeholder="Supervisor's comments here" rows="4" disabled><?php echo $sup_com5; ?></textarea>
						</div>
					...
					<div class="row">
						<div class="col-sm-6">
							<textarea name="message" id="kra6" placeholder="KRA here" rows="4" disabled><?php echo $kra6; ?></textarea>
						</div>
						<div id="kra6-checkbox" class="row">
							<div class="col-sm-2">
								...
								<span class="checkbox-kra6">
									<?php
									if ($rate6 == '5') {
										echo '<input type="checkbox" id="kra6-5" value="5" checked disabled>';
									} else {
										echo '<input type="checkbox" id="kra6-5" value="5" disabled>';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra6">
									<?php
									if ($rate6 == '4') {
										echo '<input type="checkbox" id="kra6-4" value="4" checked disabled>';
									} else {
										echo '<input type="checkbox" id="kra6-4" value="4" disabled>';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra6">
									<?php
									if ($rate6 == '3') {
										echo '<input type="checkbox" id="kra6-3" value="3" checked disabled>';
									} else {
										echo '<input type="checkbox" id="kra6-3" value="3" disabled>';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra6">
									<?php
									if ($rate6 == '2') {
										echo '<input type="checkbox" id="kra6-2" value="2" checked disabled>';
									} else {
										echo '<input type="checkbox" id="kra6-2" value="2" disabled>';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra6">
									<?php
									if ($rate6 == '1') {
										echo '<input type="checkbox" id="kra6-1" value="1" checked disabled>';
									} else {
										echo '<input type="checkbox" id="kra6-1" value="1" disabled>';
									}
									?>
							...
							<div class="col-sm-2">
								...
								<span class="checkbox-kra6">
									...
									if ($rate6 == '0' || $rate6 == null) {
										echo '<input type="checkbox" id="kra6-na" value="0" checked disabled>';
									} else {
										echo '<input type="checkbox" id="kra6-na" value="0" disabled>';
									}
									?>
						...
						<div class="col-sm-6">
							<textarea name="message" id="kpi6" placeholder="Enter KPI's here" rows="4" disabled><?php echo $kpi6; ?></textarea>
						</div>
						<div class="col-sm-3">
							<textarea name="message" id="comments6" placeholder="Enter comments here" rows="4" disabled><?php echo $comments6; ?></textarea>
						</div>
						<div class="col-sm-3">
							<textarea name="message" id="sup-comment6" placeholder="Supervisor's comments here" rows="4" disabled><?php echo $sup_com6; ?></textarea>
						</div>
					</div><br>
					<hr>
					<!-- Break -->
					...
					<div class="row">
						...
						<div class="col-md-12">
							<div id="gp1a" class="row">
								...
								<div class="col-sm-3">
									<textarea id="gp1a-comment" placeholder="Enter comments here" rows="4" disabled><?php echo $gp1a_comment; ?></textarea>
								</div>
							</div>
							<!-- Break -->
							<div id="gp1b" class="row">
								...
								<div class="col-sm-3">
									<textarea id="gp1b-comment" placeholder="Enter comments here" rows="4" disabled><?php echo $gp1b_comment; ?></textarea>
								</div>
							</div>
							<!-- Break -->
							<div id="gp1c" class="row">
								...
								<div class="col-sm-3">
									<textarea id="gp1c-comment" placeholder="Enter comments here" rows="4" disabled><?php echo $gp1c_comment; ?></textarea>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-md-12">
							<div id="gp2a" class="row">
								...
								<div class="col-sm-3">
									<textarea id="gp2a-comment" placeholder="Enter comments here" rows="4" disabled><?php echo $gp2a_comment; ?></textarea>
								</div>
							</div>
							<!-- Break -->
							<div id="gp2b" class="row">
								...
								<div class="col-sm-3">
									<textarea id="gp2b-comment" placeholder="Enter comments here" rows="4" disabled><?php echo $gp2a_comment; ?></textarea>
								</div>
							</div><br>
							<!-- Break -->
							<div id="gp2c" class="row">
								...
								<div class="col-sm-3">
									<textarea id="gp2c-comment" placeholder="Enter comments here" rows="4" disabled><?php echo $gp2c_comment; ?></textarea>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-md-12">
							<div id="gp3a" class="row">
								...
								<div class="col-sm-3">
									<textarea id="gp3a-comment" placeholder="Enter comments here" rows="4" disabled><?php echo $gp3a_comment; ?></textarea>
								</div>
							</div>
							<!-- Break -->
							<div id="gp3b" class="row">
								...
								<div class="col-sm-3">
									<textarea id="gp3b-comment" placeholder="Enter comments here" rows="4" disabled><?php echo $gp3b_comment; ?></textarea>
								</div>
							</div>
							<!-- Break -->
							<div id="gp3c" class="row">
								...
								<div class="col-sm-3">
									<textarea id="gp3c-comment" placeholder="Enter comments here" rows="4" disabled><?php echo $gp3c_comment; ?></textarea>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-md-12">
							<div id="gp4a" class="row">
								...
								<div class="col-sm-3">
									<textarea id="gp4a-comment" placeholder="Enter comments here" rows="4" disabled><?php echo $gp4a_comment; ?></textarea>
								</div>
							</div>
							<!-- Break -->
							<div id="gp4b" class="row">
								...
								<div class="col-sm-3">
									<br>
									<textarea id="gp4b-comment" placeholder="Enter comments here" rows="4" disabled><?php echo $gp4b_comment; ?></textarea>
								</div>
							</div>
							<!-- Break -->
							<div id="gp4c" class="row">
								...
								<div class="col-sm-1">
									...
									<span class="checkbox-gp4c">
										<?php
										if ($gp4c_rate == '5') {
											echo '<input type="checkbox" id="gp4c-5" class="checkbox-recommend" value="5" checked>';
										} else {
											echo '<input type="checkbox" id="gp4c-5" class="checkbox-recommend" value="5">';
										}
										?>
								...
								<div class="col-sm-1">
									...
									<span class="checkbox-gp4c">
										<?php
										if ($gp4c_rate == '4') {
											echo '<input type="checkbox" id="gp4c-4" class="checkbox-recommend" value="4" checked>';
										} else {
											echo '<input type="checkbox" id="gp4c-4" class="checkbox-recommend" value="4">';
										}
										?>
								...
								<div class="col-sm-1">
									...
									<span class="checkbox-gp4c">
										<?php
										if ($gp4c_rate == '3') {
											echo '<input type="checkbox" id="gp4c-3" class="checkbox-recommend" value="3" checked>';
										} else {
											echo '<input type="checkbox" id="gp4c-3" class="checkbox-recommend" value="3">';
										}
										?>
								...
								<div class="col-sm-1">
									...
									<span class="checkbox-gp4c">
										<?php
										if ($gp4c_rate == '2') {
											echo '<input type="checkbox" id="gp4c-2" class="checkbox-recommend" value="2" checked>';
										} else {
											echo '<input type="checkbox" id="gp4c-2" class="checkbox-recommend" value="2">';
										}
										?>
								...
								<div class="col-sm-1">
									...
									<span class="checkbox-gp4c">
										<?php
										if ($gp4c_rate == '1') {
											echo '<input type="checkbox" id="gp4c-1" class="checkbox-recommend" value="1" checked>';
										} else {
											echo '<input type="checkbox" id="gp4c-2" class="checkbox-recommend" value="2">';
										}
										?>
								...
								<div class="col-sm-1">
									...
									<span class="checkbox-gp4c">
										<?php
										if ($gp4c_rate == '0') {
											echo '<input type="checkbox" id="gp4c-na" class="checkbox-recommend" value="0" checked>';
										} else {
											echo '<input type="checkbox" id="gp4c-na" class="checkbox-recommend" value="0">';
										}
										?>
								...
								<div class="col-sm-3">
									<textarea id="gp4c-comment" placeholder="Enter comments here" rows="4" disabled><?php echo $gp4c_comment; ?></textarea>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-md-12">
							<div id="gp5a" class="row">
								...
								<div class="col-sm-3">
									<textarea id="gp5a-comment" placeholder="Enter comments here" rows="4" disabled><?php echo $gp5a_comment; ?></textarea>
								</div>
							</div>
							<!-- Break -->
							<div id="gp5b" class="row">
								...
								<div class="col-sm-3">
									<textarea id="gp5b-comment" placeholder="Enter comments here" rows="4" disabled><?php echo $gp5b_comment; ?></textarea>
								</div>
							</div>
							<!-- Break -->
							<div id="gp5c" class="row">
								...
								<div class="col-sm-3">
									<textarea id="gp5c-comment" placeholder="Enter comments here" rows="4" disabled><?php echo $gp5c_comment; ?></textarea>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-md-12">
							<div id="gp6a" class="row">
								...
								<div class="col-sm-3">
									<textarea id="gp6a-comment" placeholder="Enter comments here" rows="4" disabled><?php echo $gp6a_comment; ?></textarea>
								</div>
							</div>
							<!-- Break -->
							<div id="gp6b" class="row">
								...
								<div class="col-sm-3">
									<textarea id="gp6b-comment" placeholder="Enter comments here" rows="4" disabled><?php echo $gp6b_comment; ?></textarea>
								</div>
							</div>
							<!-- Break -->
							<div id="gp6c" class="row">
								...
								<div class="col-sm-3">
									<textarea id="gp6c-comment" placeholder="Enter comments here" rows="4" disabled><?php echo $gp6c_comment; ?></textarea>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-md-12">
							<div id="gp7a" class="row">
								...
								<div class="col-sm-3">
									<textarea id="gp7a-comment" placeholder="Enter comments here" rows="4" disabled><?php echo $gp7a_comment; ?></textarea>
								</div>
							</div><br>
							<!-- Break -->
							<div id="gp7b" class="row">
								...
								<div class="col-sm-3">
									<textarea id="gp7b-comment" placeholder="Enter comments here" rows="4" disabled><?php echo $gp7b_comment; ?></textarea>
								</div>
							</div>
							<!-- Break -->
							<div id="gp7c" class="row">
								...
								<div class="col-sm-3">
									<textarea id="gp7c-comment" placeholder="Enter comments here" rows="4" disabled><?php echo $gp7c_comment; ?></textarea>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-md-12">
							<div id="gp8a" class="row">
								...
								<div class="col-sm-3">
									<br><textarea id="gp8a-comment" placeholder="Enter comments here" rows="4" disabled><?php echo $gp8a_comment; ?></textarea>
								</div>
							</div>
							<!-- Break -->
							<div id="gp8b" class="row">
								...
								<div class="col-sm-3">
									<textarea id="gp8b-comment" placeholder="Enter comments here" rows="4" disabled><?php echo $gp8b_comment; ?></textarea>
								</div>
							</div>
							<!-- Break -->
							<div id="gp8c" class="row">
								...
								<div class="col-sm-3">
									<textarea id="gp8c-comment" placeholder="Enter comments here" rows="4" disabled><?php echo $gp8c_comment; ?></textarea>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-md-12">
							<div id="gp9a" class="row">
								...
								<div class="col-sm-3">
									<br><textarea id="gp9a-comment" placeholder="Enter comments here" rows="4" disabled><?php echo $gp9a_comment; ?></textarea>
								</div>
							</div>
							<!-- Break -->
							<div id="gp9b" class="row">
								...
								<div class="col-sm-3">
									<textarea id="gp9b-comment" placeholder="Enter comments here" rows="4" disabled><?php echo $gp9b_comment; ?></textarea>
								</div>
							</div>
							<!-- Break -->
							<div id="gp9c" class="row">
								...
								<div class="col-sm-3">
									<textarea id="gp9c-comment" placeholder="Enter comments here" rows="4" disabled><?php echo $gp9c_comment; ?></textarea>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-md-12">
							<div id="gp10a" class="row">
								...
								<div class="col-sm-3">
									<br><textarea id="gp10a-comment" placeholder="Enter comments here" rows="4" disabled><?php echo $gp10a_comment; ?></textarea>
								</div>
							</div>
							<!-- Break -->
							<div id="gp10b" class="row">
								...
								<div class="col-sm-3">
									<textarea id="gp10b-comment" placeholder="Enter comments here" rows="4" disabled><?php echo $gp10b_comment; ?></textarea>
								</div>
							</div>
							<!-- Break -->
							<div id="gp10c" class="row">
								...
								<div class="col-sm-3">
									<textarea id="gp10c-comment" placeholder="Enter comments here" rows="4" disabled><?php echo $gp10c_comment; ?></textarea>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="Accomplishments">
						<div class="row">
							...
							<div class="col-sm-12">
								...
								<div class="text-danger" id="acc_msg" hidden>Required</div>
							</div>
						</div>
					</div><br>
					...
					<div class="row main-btn">
						...
						if ($par_status == 4) {
							...
							echo '<div class="col-md-3">
													<a id="btnUpdateRec" class="button fit"><i class="fa fa-check-circle"></i><b style="color: whitesmoke;"> APPROVE PAR</b></a>
												  ...
												  <div class="col-md-3">
													<a id="btnMark" class="button fit" style="background-color: red;"><i class="fa fa-edit"></i><b style="color: whitesmoke;"> Set as for Revision</b></a>
												  </div>';
						}
						?>
					</div><br>
					<div class="row mark-reason" style="display: none;">
						<div class="col-md-12">
							<h4><b>REASON OF REVISION:</b></h4>
						</div>
						<div class="col-md-12"><textarea id="reason" placeholder="Please input your reason here" rows="3"></textarea></div>
						<div class="col-md-2"><br>
							<a id="btnDeclined" class="button fit"><i class="fa fa-save"></i><b style="color: whitesmoke;"> SUBMIT</b></a>
						</div>
						<div class="col-md-2"><br>
							<a id="btnCancel" class="button fit" style="background-color: gray;"><b style="color: whitesmoke;"> Cancel</b></a>
						</div>
					</div>
					</form>
				</div>
