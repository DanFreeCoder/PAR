            ...
            <div class="box">
                <div class="content">
                    ...
                    <div class="tab-content tabcontent-border">
                        <!-- UNEVALUATED TAB PANEL(DIRECT APPROVER) -->
                        <div class="tab-pane active" id="unevalTabPanel" role="tabpanel"><br>
                            <div class="table-responsive">
                                <table id="unEvalTable" class="table table-bordered">
                                    ...
                                    <tbody>
                                        <?php
                                        //User Role = 2 (Approver 2)
                                        //get the REVIEWED PAR FOR APPROVER 2
                                        $details->rater_name = $_SESSION['id'];
                                        $details->department = $_SESSION['dept'];
                                        $view = $details->view_uneval_par_approver2();
                                        while ($row1 = $view->fetch(PDO::FETCH_ASSOC)) {
                                            ...
                                            echo '
                                                    <tr>
                                                        ...
                                                        <td style="width: 18%"><center><a href="#" class="view-par" value="' . $row1['id'] . '"><i class="fa fa-file-alt"></i> View PAR</a> || <a href="#" class="print-par" value="' . $row1['id'] . '"><i class="fa fa-print"></i> Print PAR</a></center></td>
                                        ...
                                        while ($row1 = $view->fetch(PDO::FETCH_ASSOC)) {
                                            ...
                                            echo '
                                                    <tr>
                                                        ...
                                                        <td style="width: 10%"><center>Draft</center></td>
                                                    </tr>';
                                        }
                                        ?>
                                    </tbody>
                        ...
                        <!-- REVIEWED PAR TAB PANEL(AS AN 2nd APPROVER) -->
                        <div class="tab-pane" id="evalTabPanel" role="tabpanel"><br>
                            <div class="table-responsive">
                                <table id="evalTable" class="table table-bordered">
                                    ...
                                    <tbody>
                                        <?php
                                        //Status = 3 (For Review of Approver 3)
                                        //segregate the id's of depts  
                                        $unit_id = $_SESSION['unit'];
                                        $array_id = explode(',', $unit_id);
                                        foreach ($array_id as $value) {
                                            ...
                                            $details->eval_by = $_SESSION['id'];
                                            $view = $details->view_eval_par_approver2();
                                            while ($row1 = $view->fetch(PDO::FETCH_ASSOC)) {
                                                ...
                                                echo '
                                                        <tr>
                                                            ...
                                                            <td style="width: 18%"><center>' . $action . '</center></td>
                                                        </tr>';
                                            }
                                        }
                                        ?>
