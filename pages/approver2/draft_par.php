						...
						<div class="row uniform">
							...
							<div class="3u 12u$(xsmall)">
								<select id="status">
									...
									} elseif ($emp_status == 'Probitionary') {
										echo '<option value="0">-Select Employment Status-</option>
														...
														<option value="5">Trainee</option>
														<option value="6">Others</option>';
									} elseif ($emp_status == 'Project Based') {
										echo '<option value="0">-Select Employment Status-</option>
														<option value="1">Regular</option>
														<option value="2">Probationary</option>
			...
			<div class="box">
				<div class="content">
					...
					<div class="comments">
						...
						<div class="col-md-12"><textarea id="emp-comments" placeholder="Enter comments here" rows="2"><?php echo $emp_comment; ?></textarea></div>
