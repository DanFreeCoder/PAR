...
<body id="page-top" class="subpage">
    ...
    while ($row1 = $sel->fetch(PDO::FETCH_ASSOC)) {
        ...
        $dept_id = $row1['department'];
        $department = $row1['dept-name'];
        $project = $row1['project'];
        $emp_status = $row1['emp_status'];
        $assessment  = $row1['assessment'];
        $from;
        if (strlen($row1['review_from']) == 4) {
            $from = $row1['review_from'];
        } else {
            $from = date_format(new DateTime($row1['review_from']), 'F j, Y');
        }
        $to = date_format(new DateTime($row1['review_to']), 'F j, Y');
        $date_hire = date_format(new DateTime($row1['date_hire']), 'F j, Y');
        $rater = $row1['rater'];
        $rater_name = $row1['rater_name'];
        $rater_id = $row1['rater_id'];
        $rater_name = $row1['rater_name'];
        $emp_email = $row1['emp_email'];
        $kra_total = $row1['kra_total'];
        $gp_total = $row1['gp_total'];
        $kra_average = $row1['kra_average'];
        $gp_average = $row1['gp_average'];
        $oap_total = $row1['oap_total'];
        $oap_scale = $row1['oap_scale'];
        $accomplishment = $row1['accomplishment'];
        $prof_dev = $row1['prof_dev'];
        $prof_others = $row1['prof_others'];
        $emp_comment = $row1['emp_comment'];
        $recommendation = '';
        $gross = '';
        $remarks = '';
        //kra_kpi
        $kra1 = $row1['kra1'];
        $kpi1  = $row1['kpi1'];
        $comments1  = $row1['comments1'];
        $rate1 = $row1['rate1'];
        $kra2 = $row1['kra2'];
        $kpi2  = $row1['kpi2'];
        $comments2  = $row1['comments2'];
        $rate2 = $row1['rate2'];
        $kra3 = $row1['kra3'];
        $kpi3  = $row1['kpi3'];
        $comments3  = $row1['comments3'];
        $rate3 = $row1['rate3'];
        $kra4 = $row1['kra4'];
        $kpi4  = $row1['kpi4'];
        $comments4  = $row1['comments4'];
        $rate4 = $row1['rate4'];
        $kra5 = $row1['kra5'];
        $kpi5  = $row1['kpi5'];
        $comments5  = $row1['comments5'];
        $rate5 = $row1['rate5'];
        $kra6 = $row1['kra6'];
        $kpi6  = $row1['kpi6'];
        $comments6  = $row1['comments6'];
        $rate6 = $row1['rate6'];
        //general performance
        $gp1a_rate = $row1['gp1a_rate'];
        $gp1a_comment = $row1['gp1a_comment'];
        $gp1b_rate = $row1['gp1b_rate'];
        $gp1b_comment = $row1['gp1b_comment'];
        $gp1c_rate = $row1['gp1c_rate'];
        $gp1c_comment = $row1['gp1c_comment'];
        $gp2a_rate = $row1['gp2a_rate'];
        $gp2a_comment = $row1['gp2a_comment'];
        $gp2b_rate = $row1['gp2b_rate'];
        $gp2b_comment = $row1['gp2b_comment'];
        $gp2c_rate = $row1['gp2c_rate'];
        $gp2c_comment = $row1['gp2c_comment'];
        $gp3a_rate = $row1['gp3a_rate'];
        $gp3a_comment = $row1['gp3a_comment'];
        $gp3b_rate = $row1['gp3b_rate'];
        $gp3b_comment = $row1['gp3b_comment'];
        $gp3c_rate = $row1['gp3c_rate'];
        $gp3c_comment = $row1['gp3c_comment'];
        $gp4a_rate = $row1['gp4a_rate'];
        $gp4a_comment = $row1['gp4a_comment'];
        $gp4b_rate = $row1['gp4b_rate'];
        $gp4b_comment = $row1['gp4b_comment'];
        $gp4c_rate = $row1['gp4c_rate'];
        $gp4c_comment = $row1['gp4c_comment'];
        $gp5a_rate = $row1['gp5a_rate'];
        $gp5a_comment = $row1['gp5a_comment'];
        $gp5b_rate = $row1['gp5b_rate'];
        $gp5b_comment = $row1['gp5b_comment'];
        $gp5c_rate = $row1['gp5c_rate'];
        $gp5c_comment = $row1['gp5c_comment'];
        $gp6a_rate = $row1['gp6a_rate'];
        $gp6a_comment = $row1['gp6a_comment'];
        $gp6b_rate = $row1['gp6b_rate'];
        $gp6b_comment = $row1['gp6b_comment'];
        $gp6c_rate = $row1['gp6c_rate'];
        $gp6c_comment = $row1['gp6c_comment'];
        $gp7a_rate = $row1['gp7a_rate'];
        $gp7a_comment = $row1['gp7a_comment'];
        $gp7b_rate = $row1['gp7b_rate'];
        $gp7b_comment = $row1['gp7b_comment'];
        $gp7c_rate = $row1['gp7c_rate'];
        $gp7c_comment = $row1['gp7c_comment'];
        $gp8a_rate = $row1['gp8a_rate'];
        $gp8a_comment = $row1['gp8a_comment'];
        $gp8b_rate = $row1['gp8b_rate'];
        $gp8b_comment = $row1['gp8b_comment'];
        $gp8c_rate = $row1['gp8c_rate'];
        $gp8c_comment = $row1['gp8c_comment'];
        $gp9a_rate = $row1['gp9a_rate'];
        $gp9a_comment = $row1['gp9a_comment'];
        $gp9b_rate = $row1['gp9b_rate'];
        $gp9b_comment = $row1['gp9b_comment'];
        $gp9c_rate = $row1['gp9c_rate'];
        $gp9c_comment = $row1['gp9c_comment'];
        $gp10a_rate = $row1['gp10a_rate'];
        $gp10a_comment = $row1['gp10a_comment'];
        $gp10b_rate = $row1['gp10b_rate'];
        $gp10b_comment = $row1['gp10b_comment'];
        $gp10c_rate = $row1['gp10c_rate'];
        $gp10c_comment = $row1['gp10c_comment'];
        //pip
        $pin1 = $row1['pin1'];
        $at1 = $row1['at1'];
        $sn1 = $row1['sn1'];
                    ...
                    <form method="post" action="#">
                        <div class="row uniform">
                            <div class="3u 12u$(xsmall)">
                                <input type="text" id="eval_by" value="<?php echo $_SESSION['id']; ?>" hidden>
                                <input type="text" id="access" value="<?php echo $_SESSION['role']; ?>" hidden>
                                <input type="text" id="id" value="<?php echo $par_id; ?>" hidden>
                                <input type="text" id="name" placeholder="Employee's Name" value="<?php echo $emp_name; ?>">
                            </div>
                            <div class="3u 12u$(xsmall)">
                            ...
                            <div class="3u 12u$(xsmall)">
                                ...
                                while ($row_count = $count->fetch(PDO::FETCH_ASSOC)) {
                                    if ($row_count['counts'] > 0) {
                                        ...
                                        echo '<input type="text" id="project" placeholder="Unit/PRoject Assigned/Location" value="' . $project . '"/>';
                                    }
                                }
                                ?>
                            </div>
                            ...
                            <div class="3u 12u$(xsmall)">
                                <select id="status">
                                    <?php
                                    if ($emp_status == 'Regular' || $emp_status == 1) {
                                        echo '<option value="0">-Select Employment Status-</option>
                                    ...
                                    } elseif ($emp_status == 'Probationary' || $emp_status == 2) {
                                        echo '<option value="0">-Select Employment Status-</option>
														<option value="1">Regular</option>
														<option value="2" selected>Probationary</option>
														<option value="3">Project Based</option>
														<option value="4">Casual</option>
														<option value="5">Trainee</option>
														<option value="6">Others</option>';
                                    } elseif ($emp_status == 'Project Based' || $emp_status == 3) {
                                        echo '<option value="0">-Select Employment Status-</option>
														<option value="1">Regular</option>
														<option value="2">Probationary</option>
														<option value="3" selected>Project Based</option>
														<option value="4">Casual</option>
														<option value="5">Trainee</option>
														<option value="6">Others</option>';
                                    } elseif ($emp_status == 'Casual' || $emp_status == 4) {
                                        echo '<option value="0">-Select Employment Status-</option>
														<option value="1">Regular</option>
														<option value="2">Probationary</option>
														<option value="3">Project Based</option>
														<option value="4" selected>Casual</option>
														<option value="5">Trainee</option>
														<option value="6">Others</option>';
                                    } elseif ($emp_status == 'Trainee' || $emp_status == 5) {
                                        echo '<option value="0">-Select Employment Status-</option>
														<option value="1">Regular</option>
														<option value="2">Probationary</option>
														<option value="3">Project Based</option>
														<option value="4">Casual</option>
														<option value="5" selected>Trainee</option>
														<option value="6">Others</option>';
                                    } elseif ($emp_status == 'Others' || $emp_status == 6) {
                                        echo '<option value="0">-Select Employment Status-</option>
														<option value="1">Regular</option>
														<option value="2">Probationary</option>
														<option value="3">Project Based</option>
                                        ...
                                        echo '<option value="0" selected>-Select Employment Status-</option>
														<option value="1">Regular</option>
														<option value="2">Probationary</option>
														<option value="3">Project Based</option>
														<option value="4">Casual</option>
                            ...
                            <div class="3u 12u$(xsmall)">
                                <select id="assessment">
                                    ...
                                    if ($assessment == 'Annual') {
                                        echo '<option value="0">-Performance Assessment-</option>
														  ...
														  <option value="6">Others</option>';
                                    } elseif ($assessment == '5th Month') {
                                        echo '<option value="0">-Performance Assessment-</option>
														  <option value="1">Annual</option>
														  <option value="7">Mid Year</option>
														  <option value="2" selected>5th Month</option>
														  <option value="3">3rd Month</option>
														  <option value="5">Training</option>
														  <option value="6">Others</option>';
                                    } elseif ($assessment == '3rd Month') {
                                        echo '<option value="0">-Performance Assessment-</option>
														  <option value="1">Annual</option>
														  <option value="7">Mid Year</option>
														  <option value="2">5th Month</option>
														  <option value="3" selected>3rd Month</option>
														  <option value="5">Training</option>
														  <option value="6">Others</option>';
                                    } elseif ($assessment == '2nd Month') {
                                        echo '<option value="0">-Performance Assessment-</option>
														  <option value="1">Annual</option>
														  <option value="7">Mid Year</option>
														  <option value="2">5th Month</option>
														  <option value="3">3rd Month</option>
														  <option value="4" selected>2nd Month</option>
														  <option value="5">Training</option>
														  <option value="6">Others</option>';
                                    } elseif ($assessment == 'Training') {
                                        echo '<option value="0">-Performance Assessment-</option>
														  <option value="1">Annual</option>
														  <option value="7">Mid Year</option>
														  <option value="2">5th Month</option>
														  <option value="3">3rd Month</option>
														  <option value="5" selected>Training</option>
														  <option value="6">Others</option>';
                                    } elseif ($assessment == 'Others') {
                                        echo '<option value="0">-Performance Assessment-</option>
														  <option value="1">Annual</option>
														  <option value="7">Mid Year</option>
														  <option value="2">5th Month</option>
														  ...
														  <option value="5">Training</option>
														  <option value="6" selected>Others</option>';
                                    } elseif ($assessment == 'Mid Year') {
                                        echo '<option value="0">-Performance Assessment-</option>
														  <option value="1">Annual</option>
														  <option value="7" selected>Mid Year</option>
														  <option value="2">5th Month</option>
														  <option value="3">3rd Month</option>
														  <option value="5">Training</option>
														  <option value="6">Others</option>';
                                    } else {
                                        echo '<option value="0" selected>-Performance Assessment-</option>
														  <option value="1">Annual</option>
														  <option value="7">Mid Year</option>
														  <option value="2">5th Month</option>
														  <option value="3">3rd Month</option>
                            ...
                            <div class="3u 12u$(xsmall)" id="from">
                                <input type="text" id="review-from" class="datepicker" placeholder="Review Period From" value="<?php echo $from; ?>">
                            </div>
                            <div class="3u 12u$(xsmall)">
                                <input type="text" id="review-to" class="datepicker" placeholder="Review Period To" value="<?php echo $to; ?>" />
                            </div>
                            <!-- Break -->
                            <div class="3u 12u$(xsmall)">
                                <input type="text" id="date-hire" class="datepicker" placeholder="Date Hired" value="<?php echo $date_hire; ?>" />
                            </div>
                            <div class="3u 12u$(xsmall)">
                                <select id="rater" disabled>
                                    <?php
                                    if ($rater == 'Immediate Superior' || $rater == 'Team Lead/Supervisor' || $rater == 2) {
                                        echo '<option value="0" disabled>- 1st Approver -</option>
                                        ...
                                        echo '<option value="0" selected disabled>- 1st Approver -</option>
														  <option value="2">Immediate Superior</option>
														  <option value="3">Manager</option>
														  <option value="4">Sr. Manager</option>';
                                    }
                            ...
                            <div class="3u 12u$(xsmall)">
                                <input type="text" id="emp_email" value="<?php echo $emp_email; ?>" />
                            </div>
                    </form>
                </div>
            </div>
            ...
            <div class="box">
                <div class="content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <textarea name="message" id="sup-comment1" placeholder="Supervisor's comments here" rows="4"></textarea>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <textarea name="message" id="sup-comment2" placeholder="Supervisor's comments here" rows="4"></textarea>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <textarea name="message" id="sup-comment3" placeholder="Supervisor's comments here" rows="4"></textarea>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <textarea name="message" id="sup-comment4" placeholder="Supervisor's comments here" rows="4"></textarea>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <textarea name="message" id="sup-comment5" placeholder="Supervisor's comments here" rows="4"></textarea>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <textarea name="message" id="sup-comment6" placeholder="Supervisor's comments here" rows="4"></textarea>
                            ...
                            <div id="gp1a" class="row">
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp1a">
                                        <?php
                                        if ($gp1a_rate == '5') {
                                            echo '<input type="checkbox" id="gp1a-5" value="5" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp1a-5" value="5">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp1a">
                                        <?php
                                        if ($gp1a_rate == '4') {
                                            echo '<input type="checkbox" id="gp1a-4" value="4" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp1a-4" value="4">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp1a">
                                        <?php
                                        if ($gp1a_rate == '3') {
                                            echo '<input type="checkbox" id="gp1a-3" value="3" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp1a-3" value="3">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp1a">
                                        <?php
                                        if ($gp1a_rate == '2') {
                                            echo '<input type="checkbox" id="gp1a-2" value="2" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp1a-2" value="2">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp1a">
                                        <?php
                                        if ($gp1a_rate == '1') {
                                            echo '<input type="checkbox" id="gp1a-1" value="1" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp1a-1" value="1">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp1a">
                                        <?php
                                        if ($gp1a_rate == '0') {
                                            echo '<input type="checkbox" id="gp1a-na" value="0" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp1a-na" value="0">';
                                        }
                                        ?>
                            ...
                            <div id="gp1b" class="row">
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp1b">
                                        <?php
                                        if ($gp1b_rate == '5') {
                                            echo '<input type="checkbox" id="gp1b-5" value="5" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp1b-5" value="5">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp1b">
                                        <?php
                                        if ($gp1b_rate == '4') {
                                            echo '<input type="checkbox" id="gp1b-4" value="4" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp1b-4" value="4">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp1b">
                                        <?php
                                        if ($gp1b_rate == '3') {
                                            echo '<input type="checkbox" id="gp1b-3" value="3" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp1b-3" value="3">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp1b">
                                        <?php
                                        if ($gp1b_rate == '2') {
                                            echo '<input type="checkbox" id="gp1b-2" value="2" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp1b-2" value="2">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp1b">
                                        <?php
                                        if ($gp1b_rate == '1') {
                                            echo '<input type="checkbox" id="gp1b-1" value="1" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp1b-1" value="1">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp1b">
                                        <?php
                                        if ($gp1b_rate == '0') {
                                            echo '<input type="checkbox" id="gp1b-na" value="0" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp1b-na" value="0">';
                                        }
                                        ?>
                            ...
                            <div id="gp1c" class="row">
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp1c">
                                        <?php
                                        if ($gp1c_rate == '5') {
                                            echo '<input type="checkbox" id="gp1c-5" value="5" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp1c-5" value="5">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp1c">
                                        <?php
                                        if ($gp1c_rate == '4') {
                                            echo '<input type="checkbox" id="gp1c-4" value="4" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp1c-4" value="4">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp1c">
                                        <?php
                                        if ($gp1c_rate == '3') {
                                            echo '<input type="checkbox" id="gp1c-3" value="3" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp1c-3" value="3">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp1c">
                                        <?php
                                        if ($gp1c_rate == '2') {
                                            echo '<input type="checkbox" id="gp1c-2" value="2" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp1c-2" value="2">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp1c">
                                        <?php
                                        if ($gp1c_rate == '1') {
                                            echo '<input type="checkbox" id="gp1c-1" value="1" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp1c-1" value="1">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp1c">
                                        <?php
                                        if ($gp1c_rate == '0') {
                                            echo '<input type="checkbox" id="gp1c-na" value="0" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp1c-na" value="0">';
                                        }
                                        ?>
                            ...
                            <div id="gp2a" class="row">
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp2a">
                                        <?php
                                        if ($gp2a_rate == '5') {
                                            echo '<input type="checkbox" id="gp2a-5" value="5" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp2a-5" value="5">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp2a">
                                        <?php
                                        if ($gp2a_rate == '4') {
                                            echo '<input type="checkbox" id="gp2a-4" value="4" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp2a-4" value="4">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp2a">
                                        <?php
                                        if ($gp2a_rate == '3') {
                                            echo '<input type="checkbox" id="gp2a-3" value="3" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp2a-3" value="3">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp2a">
                                        <?php
                                        if ($gp2a_rate == '2') {
                                            echo '<input type="checkbox" id="gp2a-2" value="2" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp2a-2" value="2">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp2a">
                                        <?php
                                        if ($gp2a_rate == '1') {
                                            echo '<input type="checkbox" id="gp2a-1" value="1" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp2a-1" value="1">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp2a">
                                        <?php
                                        if ($gp2a_rate == '0') {
                                            echo '<input type="checkbox" id="gp2a-na" value="0" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp2a-na" value="0">';
                                        }
                                        ?>
                            ...
                            <div id="gp2b" class="row">
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp2b">
                                        <?php
                                        if ($gp2b_rate == '5') {
                                            echo '<input type="checkbox" id="gp2b-5" value="5" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp2b-5" value="5">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp2b">
                                        <?php
                                        if ($gp2b_rate == '4') {
                                            echo '<input type="checkbox" id="gp2b-4" value="4" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp2b-4" value="4">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp2b">
                                        <?php
                                        if ($gp2b_rate == '3') {
                                            echo '<input type="checkbox" id="gp2b-3" value="3" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp2b-3" value="3">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp2b">
                                        <?php
                                        if ($gp2b_rate == '2') {
                                            echo '<input type="checkbox" id="gp2b-2" value="2" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp2b-2" value="2">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp2b">
                                        <?php
                                        if ($gp2b_rate == '1') {
                                            echo '<input type="checkbox" id="gp2b-1" value="1" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp2b-1" value="1">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp2b">
                                        <?php
                                        if ($gp2b_rate == '0') {
                                            echo '<input type="checkbox" id="gp2b-na" value="0" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp2b-na" value="0">';
                                        }
                                        ?>
                            ...
                            <div id="gp2c" class="row">
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp2c">
                                        <?php
                                        if ($gp2c_rate == '5') {
                                            echo '<input type="checkbox" id="gp2c-5" value="5" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp2c-5" value="5">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp2c">
                                        <?php
                                        if ($gp2c_rate == '4') {
                                            echo '<input type="checkbox" id="gp2c-4" value="4" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp2c-4" value="4">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp2c">
                                        <?php
                                        if ($gp2c_rate == '3') {
                                            echo '<input type="checkbox" id="gp2c-3" value="3" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp2c-3" value="3">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp2c">
                                        <?php
                                        if ($gp2c_rate == '2') {
                                            echo '<input type="checkbox" id="gp2c-2" value="2" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp2c-2" value="2">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp2c">
                                        <?php
                                        if ($gp2c_rate == '1') {
                                            echo '<input type="checkbox" id="gp2c-1" value="1" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp2c-1" value="1">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp2c">
                                        <?php
                                        if ($gp2c_rate == '0') {
                                            echo '<input type="checkbox" id="gp2c-na" value="0" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp2c-na" value="0">';
                                        }
                                        ?>
                            ...
                            <div id="gp3a" class="row">
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp3a">
                                        <?php
                                        if ($gp3a_rate == '5') {
                                            echo '<input type="checkbox" id="gp3a-5" value="5" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp3a-5" value="5">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp3a">
                                        <?php
                                        if ($gp3a_rate == '4') {
                                            echo '<input type="checkbox" id="gp3a-4" value="4" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp3a-4" value="4">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp3a">
                                        <?php
                                        if ($gp3a_rate == '3') {
                                            echo '<input type="checkbox" id="gp3a-3" value="3" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp3a-3" value="3">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp3a">
                                        <?php
                                        if ($gp3a_rate == '2') {
                                            echo '<input type="checkbox" id="gp3a-2" value="2" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp3a-2" value="2">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp3a">
                                        <?php
                                        if ($gp3a_rate == '1') {
                                            echo '<input type="checkbox" id="gp3a-1" value="1" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp3a-1" value="1">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp3a">
                                        <?php
                                        if ($gp3a_rate == '0') {
                                            echo '<input type="checkbox" id="gp3a-na" value="0" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp3a-na" value="0">';
                                        }
                                        ?>
                            ...
                            <div id="gp3b" class="row">
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp3b">
                                        <?php
                                        if ($gp3b_rate == '5') {
                                            echo '<input type="checkbox" id="gp3b-5" value="5" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp3b-5" value="5">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp3b">
                                        <?php
                                        if ($gp3b_rate == '4') {
                                            echo '<input type="checkbox" id="gp3b-4" value="4" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp3b-4" value="4">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp3b">
                                        <?php
                                        if ($gp3b_rate == '3') {
                                            echo '<input type="checkbox" id="gp3b-3" value="3" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp3b-3" value="3">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp3b">
                                        <?php
                                        if ($gp3b_rate == '2') {
                                            echo '<input type="checkbox" id="gp3b-2" value="2" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp3b-2" value="2">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp3b">
                                        <?php
                                        if ($gp3b_rate == '1') {
                                            echo '<input type="checkbox" id="gp3b-1" value="1" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp3b-1" value="1">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp3b">
                                        <?php
                                        if ($gp3b_rate == '0') {
                                            echo '<input type="checkbox" id="gp3b-na" value="0" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp3b-na" value="0">';
                                        }
                                        ?>
                            ...
                            <div id="gp3c" class="row">
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp3c">
                                        <?php
                                        if ($gp3c_rate == '5') {
                                            echo '<input type="checkbox" id="gp3c-5" value="5" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp3c-5" value="5">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp3c">
                                        <?php
                                        if ($gp3c_rate == '4') {
                                            echo '<input type="checkbox" id="gp3c-4" value="4" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp3c-4" value="4">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp3c">
                                        <?php
                                        if ($gp3c_rate == '3') {
                                            echo '<input type="checkbox" id="gp3c-3" value="3" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp3c-3" value="3">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp3c">
                                        <?php
                                        if ($gp3c_rate == '2') {
                                            echo '<input type="checkbox" id="gp3c-2" value="2" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp3c-2" value="2">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp3c">
                                        <?php
                                        if ($gp3c_rate == '1') {
                                            echo '<input type="checkbox" id="gp3c-1" value="1" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp3c-1" value="1">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp3c">
                                        <?php
                                        if ($gp3c_rate == '0') {
                                            echo '<input type="checkbox" id="gp3c-na" value="0" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp3c-na" value="0">';
                                        }
                                        ?>
                            ...
                            <div id="gp4a" class="row">
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp4a">
                                        <?php
                                        if ($gp4a_rate == '5') {
                                            echo '<input type="checkbox" id="gp4a-5" value="5" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp4a-5" value="5">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp4a">
                                        <?php
                                        if ($gp4a_rate == '4') {
                                            echo '<input type="checkbox" id="gp4a-4" value="4" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp4a-4" value="4">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp4a">
                                        <?php
                                        if ($gp4a_rate == '3') {
                                            echo '<input type="checkbox" id="gp4a-3" value="3" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp4a-3" value="3">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp4a">
                                        <?php
                                        if ($gp4a_rate == '2') {
                                            echo '<input type="checkbox" id="gp4a-2" value="2" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp4a-2" value="2">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp4a">
                                        <?php
                                        if ($gp4a_rate == '1') {
                                            echo '<input type="checkbox" id="gp4a-1" value="1" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp4a-1" value="1">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp4a">
                                        <?php
                                        if ($gp4a_rate == '0') {
                                            echo '<input type="checkbox" id="gp4a-na" value="0" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp4a-na" value="0">';
                                        }
                                        ?>
                            ...
                            <div id="gp4b" class="row">
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp4b">
                                        <?php
                                        if ($gp4b_rate == '5') {
                                            echo '<input type="checkbox" id="gp4b-5" value="5" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp4b-5" value="5">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp4b">
                                        <?php
                                        if ($gp4b_rate == '4') {
                                            echo '<input type="checkbox" id="gp4b-4" value="4" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp4b-4" value="4">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp4b">
                                        <?php
                                        if ($gp4b_rate == '3') {
                                            echo '<input type="checkbox" id="gp4b-3" value="3" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp4b-3" value="3">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp4b">
                                        <?php
                                        if ($gp4b_rate == '2') {
                                            echo '<input type="checkbox" id="gp4b-2" value="2" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp4b-2" value="2">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp4b">
                                        <?php
                                        if ($gp4b_rate == '1') {
                                            echo '<input type="checkbox" id="gp4b-1" value="1" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp4b-1" value="1">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp4b">
                                        <?php
                                        if ($gp4b_rate == '0') {
                                            echo '<input type="checkbox" id="gp4b-na" value="0" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp4b-na" value="0">';
                                        }
                                        ?>
                            ...
                            <div id="gp4c" class="row">
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp4c">
                                        <?php
                                        if ($gp4c_rate == '5') {
                                            echo '<input type="checkbox" id="gp4c-5" value="5" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp4c-5" value="5">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp4c">
                                        <?php
                                        if ($gp4c_rate == '4') {
                                            echo '<input type="checkbox" id="gp4c-4" value="4" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp4c-4" value="4">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp4c">
                                        <?php
                                        if ($gp4c_rate == '3') {
                                            echo '<input type="checkbox" id="gp4c-3" value="3" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp4c-3" value="3">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp4c">
                                        <?php
                                        if ($gp4c_rate == '2') {
                                            echo '<input type="checkbox" id="gp4c-2" value="2" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp4c-2" value="2">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp4c">
                                        <?php
                                        if ($gp4c_rate == '1') {
                                            echo '<input type="checkbox" id="gp4c-1" value="1" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp4c-1" value="1">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp4c">
                                        <?php
                                        if ($gp4c_rate == '0') {
                                            echo '<input type="checkbox" id="gp4c-na" value="0" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp4c-na" value="0">';
                                        }
                                        ?>
                            ...
                            <div id="gp5a" class="row">
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp5a">
                                        <?php
                                        if ($gp5a_rate == '5') {
                                            echo '<input type="checkbox" id="gp5a-5" value="5" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp5a-5" value="5">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp5a">
                                        <?php
                                        if ($gp5a_rate == '4') {
                                            echo '<input type="checkbox" id="gp5a-4" value="5" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp5a-4" value="4">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp5a">
                                        <?php
                                        if ($gp5a_rate == '3') {
                                            echo '<input type="checkbox" id="gp5a-3" value="3" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp5a-3" value="3">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp5a">
                                        <?php
                                        if ($gp5a_rate == '2') {
                                            echo '<input type="checkbox" id="gp5a-2" value="2" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp5a-2" value="2">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp5a">
                                        <?php
                                        if ($gp5a_rate == '1') {
                                            echo '<input type="checkbox" id="gp5a-1" value="1" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp5a-1" value="1">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp5a">
                                        <?php
                                        if ($gp5a_rate == '0') {
                                            echo '<input type="checkbox" id="gp5a-na" value="0" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp5a-na" value="0">';
                                        }
                                        ?>
                            ...
                            <div id="gp5b" class="row">
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp5b">
                                        <?php
                                        if ($gp5b_rate == '5') {
                                            echo '<input type="checkbox" id="gp5b-5" value="5" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp5b-5" value="5">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp5b">
                                        <?php
                                        if ($gp5b_rate == '4') {
                                            echo '<input type="checkbox" id="gp5b-4" value="4" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp5b-4" value="4">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp5b">
                                        <?php
                                        if ($gp5b_rate == '3') {
                                            echo '<input type="checkbox" id="gp5b-3" value="3" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp5b-3" value="3">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp5b">
                                        <?php
                                        if ($gp5b_rate == '2') {
                                            echo '<input type="checkbox" id="gp5b-2" value="2" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp5b-2" value="2">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp5b">
                                        <?php
                                        if ($gp5b_rate == '1') {
                                            echo '<input type="checkbox" id="gp5b-1" value="1" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp5b-1" value="1">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp5b">
                                        <?php
                                        if ($gp5b_rate == '0') {
                                            echo '<input type="checkbox" id="gp5b-na" value="0" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp5b-na" value="0">';
                                        }
                                        ?>
                            ...
                            <div id="gp5c" class="row">
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp5c">
                                        <?php
                                        if ($gp5c_rate == '5') {
                                            echo '<input type="checkbox" id="gp5c-5" value="5" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp5c-5" value="5">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp5c">
                                        <?php
                                        if ($gp5c_rate == '4') {
                                            echo '<input type="checkbox" id="gp5c-4" value="4" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp5c-4" value="4">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp5c">
                                        <?php
                                        if ($gp5c_rate == '3') {
                                            echo '<input type="checkbox" id="gp5c-3" value="3" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp5c-3" value="3">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp5c">
                                        <?php
                                        if ($gp5c_rate == '2') {
                                            echo '<input type="checkbox" id="gp5c-2" value="2" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp5c-2" value="2">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp5c">
                                        <?php
                                        if ($gp5c_rate == '1') {
                                            echo '<input type="checkbox" id="gp5c-1" value="1" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp5c-1" value="1">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp5c">
                                        <?php
                                        if ($gp5c_rate == '0') {
                                            echo '<input type="checkbox" id="gp5c-na" value="0" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp5c-na" value="0">';
                                        }
                                        ?>
                            ...
                            <div id="gp6a" class="row">
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp6a">
                                        <?php
                                        if ($gp6a_rate == '5') {
                                            echo '<input type="checkbox" id="gp6a-5" value="5" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp6a-5" value="5">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp6a">
                                        <?php
                                        if ($gp6a_rate == '4') {
                                            echo '<input type="checkbox" id="gp6a-4" value="4" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp6a-4" value="4">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp6a">
                                        <?php
                                        if ($gp6a_rate == '3') {
                                            echo '<input type="checkbox" id="gp6a-3" value="3" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp6a-3" value="3">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp6a">
                                        <?php
                                        if ($gp6a_rate == '2') {
                                            echo '<input type="checkbox" id="gp6a-2" value="2" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp6a-2" value="2">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp6a">
                                        <?php
                                        if ($gp6a_rate == '1') {
                                            echo '<input type="checkbox" id="gp6a-1" value="1" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp6a-1" value="1">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp6a">
                                        <?php
                                        if ($gp6a_rate == '0') {
                                            echo '<input type="checkbox" id="gp6a-na" value="0" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp6a-na" value="0">';
                                        }
                                        ?>
                            ...
                            <div id="gp6b" class="row">
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp6b">
                                        <?php
                                        if ($gp6b_rate == '5') {
                                            echo '<input type="checkbox" id="gp6b-5" value="5" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp6b-5" value="5">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp6b">
                                        <?php
                                        if ($gp6b_rate == '4') {
                                            echo '<input type="checkbox" id="gp6b-4" value="4" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp6b-4" value="4">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp6b">
                                        <?php
                                        if ($gp6b_rate == '3') {
                                            echo '<input type="checkbox" id="gp6b-3" value="3" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp6b-3" value="3">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp6b">
                                        <?php
                                        if ($gp6b_rate == '2') {
                                            echo '<input type="checkbox" id="gp6b-2" value="2" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp6b-2" value="2">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp6b">
                                        <?php
                                        if ($gp6b_rate == '1') {
                                            echo '<input type="checkbox" id="gp6b-1" value="1" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp6b-1" value="1">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp6b">
                                        <?php
                                        if ($gp6b_rate == '0') {
                                            echo '<input type="checkbox" id="gp6b-na" value="0" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp6b-na" value="0">';
                                        }
                                        ?>
                            ...
                            <div id="gp6c" class="row">
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp6c">
                                        <?php
                                        if ($gp6c_rate == '5') {
                                            echo '<input type="checkbox" id="gp6c-5" value="5" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp6c-5" value="5">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp6c">
                                        <?php
                                        if ($gp6c_rate == '4') {
                                            echo '<input type="checkbox" id="gp6c-4" value="4" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp6c-4" value="4">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp6c">
                                        <?php
                                        if ($gp6c_rate == '3') {
                                            echo '<input type="checkbox" id="gp6c-3" value="3" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp6c-3" value="3">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp6c">
                                        <?php
                                        if ($gp6c_rate == '2') {
                                            echo '<input type="checkbox" id="gp6c-2" value="2" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp6c-2" value="2">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp6c">
                                        <?php
                                        if ($gp6c_rate == '1') {
                                            echo '<input type="checkbox" id="gp6c-1" value="1" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp6c-1" value="1">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp6c">
                                        <?php
                                        if ($gp6c_rate == '0') {
                                            echo '<input type="checkbox" id="gp6c-na" value="0" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp6c-na" value="0">';
                                        }
                                        ?>
                            ...
                            <div id="gp7a" class="row">
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp7a">
                                        <?php
                                        if ($gp7a_rate == '5') {
                                            echo '<input type="checkbox" id="gp7a-5" value="5" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp7a-5" value="5">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp7a">
                                        <?php
                                        if ($gp7a_rate == '4') {
                                            echo '<input type="checkbox" id="gp7a-4" value="4" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp7a-4" value="4">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp7a">
                                        <?php
                                        if ($gp7a_rate == '3') {
                                            echo '<input type="checkbox" id="gp7a-3" value="3" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp7a-3" value="3">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp7a">
                                        <?php
                                        if ($gp7a_rate == '2') {
                                            echo '<input type="checkbox" id="gp7a-2" value="2" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp7a-2" value="2">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp7a">
                                        <?php
                                        if ($gp7a_rate == '1') {
                                            echo '<input type="checkbox" id="gp7a-1" value="1" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp7a-1" value="1">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp7a">
                                        <?php
                                        if ($gp7a_rate == '0') {
                                            echo '<input type="checkbox" id="gp7a-na" value="0" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp7a-na" value="0">';
                                        }
                                        ?>
                            ...
                            <div id="gp7b" class="row">
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp7b">
                                        <?php
                                        if ($gp7b_rate == '5') {
                                            echo '<input type="checkbox" id="gp7b-5" value="5" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp7b-5" value="5">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp7b">
                                        <?php
                                        if ($gp7b_rate == '4') {
                                            echo '<input type="checkbox" id="gp7b-4" value="4" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp7b-4" value="4">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp7b">
                                        <?php
                                        if ($gp7b_rate == '3') {
                                            echo '<input type="checkbox" id="gp7b-3" value="3" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp7b-3" value="3">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp7b">
                                        <?php
                                        if ($gp7b_rate == '2') {
                                            echo '<input type="checkbox" id="gp7b-2" value="2" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp7b-2" value="2">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp7b">
                                        <?php
                                        if ($gp7b_rate == '1') {
                                            echo '<input type="checkbox" id="gp7b-1" value="1" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp7b-1" value="1">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp7b">
                                        <?php
                                        if ($gp7b_rate == '0') {
                                            echo '<input type="checkbox" id="gp7b-na" value="0" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp7b-na" value="0">';
                                        }
                                        ?>
                            ...
                            <div id="gp7c" class="row">
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp7c">
                                        <?php
                                        if ($gp7c_rate == '5') {
                                            echo '<input type="checkbox" id="gp7c-5" value="5" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp7c-5" value="5">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp7c">
                                        <?php
                                        if ($gp7c_rate == '4') {
                                            echo '<input type="checkbox" id="gp7c-4" value="4" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp7c-4" value="4">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp7c">
                                        <?php
                                        if ($gp7c_rate == '3') {
                                            echo '<input type="checkbox" id="gp7c-3" value="3" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp7c-3" value="3">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp7c">
                                        <?php
                                        if ($gp7c_rate == '2') {
                                            echo '<input type="checkbox" id="gp7c-2" value="2" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp7c-2" value="2">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp7c">
                                        <?php
                                        if ($gp7c_rate == '1') {
                                            echo '<input type="checkbox" id="gp7c-1" value="1" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp7c-1" value="1">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp7c">
                                        <?php
                                        if ($gp7c_rate == '0') {
                                            echo '<input type="checkbox" id="gp7c-na" value="0" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp7c-na" value="0">';
                                        }
                                        ?>
                            ...
                            <div id="gp8a" class="row">
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp8a">
                                        <?php
                                        if ($gp8a_rate == '5') {
                                            echo '<input type="checkbox" id="gp8a-5" value="5" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp8a-5" value="5">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp8a">
                                        <?php
                                        if ($gp8a_rate == '4') {
                                            echo '<input type="checkbox" id="gp8a-4" value="4" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp8a-4" value="4">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp8a">
                                        <?php
                                        if ($gp8a_rate == '3') {
                                            echo '<input type="checkbox" id="gp8a-3" value="3" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp8a-3" value="3">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp8a">
                                        <?php
                                        if ($gp8a_rate == '2') {
                                            echo '<input type="checkbox" id="gp8a-2" value="2" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp8a-2" value="2">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp8a">
                                        <?php
                                        if ($gp8a_rate == '1') {
                                            echo '<input type="checkbox" id="gp8a-1" value="1" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp8a-1" value="1">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp8a">
                                        <?php
                                        if ($gp8a_rate == '0') {
                                            echo '<input type="checkbox" id="gp8a-na" value="0" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp8a-na" value="0">';
                                        }
                                        ?>
                            ...
                            <div id="gp8b" class="row">
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp8b">
                                        <?php
                                        if ($gp8b_rate == '5') {
                                            echo '<input type="checkbox" id="gp8b-5" value="5" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp8b-5" value="5">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp8b">
                                        <?php
                                        if ($gp8b_rate == '4') {
                                            echo '<input type="checkbox" id="gp8b-4" value="4" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp8b-4" value="4">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp8b">
                                        <?php
                                        if ($gp8b_rate == '3') {
                                            echo '<input type="checkbox" id="gp8b-3" value="3" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp8b-3" value="3">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp8b">
                                        <?php
                                        if ($gp8b_rate == '2') {
                                            echo '<input type="checkbox" id="gp8b-2" value="2" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp8b-2" value="2">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp8b">
                                        <?php
                                        if ($gp8b_rate == '1') {
                                            echo '<input type="checkbox" id="gp8b-1" value="1" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp8b-1" value="1">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp8b">
                                        <?php
                                        if ($gp8b_rate == '0') {
                                            echo '<input type="checkbox" id="gp8b-na" value="0" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp8b-na" value="0">';
                                        }
                                        ?>
                            ...
                            <div id="gp8c" class="row">
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp8c">
                                        <?php
                                        if ($gp8c_rate == '5') {
                                            echo '<input type="checkbox" id="gp8c-5" value="5" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp8c-5" value="5">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp8c">
                                        <?php
                                        if ($gp8c_rate == '4') {
                                            echo '<input type="checkbox" id="gp8c-4" value="4" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp8c-4" value="4">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp8c">
                                        <?php
                                        if ($gp8c_rate == '3') {
                                            echo '<input type="checkbox" id="gp8c-3" value="3" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp8c-3" value="3">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp8c">
                                        <?php
                                        if ($gp8c_rate == '2') {
                                            echo '<input type="checkbox" id="gp8c-2" value="2" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp8c-2" value="2">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp8c">
                                        <?php
                                        if ($gp8c_rate == '1') {
                                            echo '<input type="checkbox" id="gp8c-1" value="1" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp8c-1" value="1">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp8c">
                                        <?php
                                        if ($gp8c_rate == '0') {
                                            echo '<input type="checkbox" id="gp8c-na" value="0" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp8c-na" value="0">';
                                        }
                                        ?>
                            ...
                            <div id="gp9a" class="row">
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp9a">
                                        <?php
                                        if ($gp9a_rate == '5') {
                                            echo '<input type="checkbox" id="gp9a-5" value="5" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp9a-5" value="5">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp9a">
                                        <?php
                                        if ($gp9a_rate == '4') {
                                            echo '<input type="checkbox" id="gp9a-4" value="4" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp9a-4" value="4">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp9a">
                                        <?php
                                        if ($gp9a_rate == '3') {
                                            echo '<input type="checkbox" id="gp9a-3" value="3" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp9a-3" value="3">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp9a">
                                        <?php
                                        if ($gp9a_rate == '2') {
                                            echo '<input type="checkbox" id="gp9a-2" value="2" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp9a-2" value="2">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp9a">
                                        <?php
                                        if ($gp9a_rate == '1') {
                                            echo '<input type="checkbox" id="gp9a-1" value="1" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp9a-1" value="1">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp9a">
                                        <?php
                                        if ($gp9a_rate == '0') {
                                            echo '<input type="checkbox" id="gp9a-na" value="0" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp9a-na" value="0">';
                                        }
                                        ?>
                            ...
                            <div id="gp9b" class="row">
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp9b">
                                        <?php
                                        if ($gp9b_rate == '5') {
                                            echo '<input type="checkbox" id="gp9b-5" value="5" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp9b-5" value="5">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp9b">
                                        <?php
                                        if ($gp9b_rate == '4') {
                                            echo '<input type="checkbox" id="gp9b-4" value="4" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp9b-4" value="4">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp9b">
                                        <?php
                                        if ($gp9b_rate == '3') {
                                            echo '<input type="checkbox" id="gp9b-3" value="3" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp9b-3" value="3">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp9b">
                                        <?php
                                        if ($gp9b_rate == '2') {
                                            echo '<input type="checkbox" id="gp9b-2" value="2" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp9b-2" value="2">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp9b">
                                        <?php
                                        if ($gp9b_rate == '1') {
                                            echo '<input type="checkbox" id="gp9b-1" value="1" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp9b-1" value="1">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp9b">
                                        <?php
                                        if ($gp9b_rate == '0') {
                                            echo '<input type="checkbox" id="gp9b-na" value="0" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp9b-na" value="0">';
                                        }
                                        ?>
                            ...
                            <div id="gp9c" class="row">
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp9c">
                                        <?php
                                        if ($gp9c_rate == '5') {
                                            echo '<input type="checkbox" id="gp9c-5" value="5" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp9c-5" value="5">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp9c">
                                        <?php
                                        if ($gp9c_rate == '4') {
                                            echo '<input type="checkbox" id="gp9c-4" value="4" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp9c-4" value="4">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp9c">
                                        <?php
                                        if ($gp9c_rate == '3') {
                                            echo '<input type="checkbox" id="gp9c-3" value="3" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp9c-3" value="3">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp9c">
                                        <?php
                                        if ($gp9c_rate == '2') {
                                            echo '<input type="checkbox" id="gp9c-2" value="2" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp9c-2" value="2">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp9c">
                                        <?php
                                        if ($gp9c_rate == '1') {
                                            echo '<input type="checkbox" id="gp9c-1" value="1" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp9c-1" value="1">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp9c">
                                        <?php
                                        if ($gp9c_rate == '0') {
                                            echo '<input type="checkbox" id="gp9c-na" value="0" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp9c-na" value="0">';
                                        }
                                        ?>
                            ...
                            <div id="gp10a" class="row">
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp10a">
                                        <?php
                                        if ($gp10a_rate == '5') {
                                            echo '<input type="checkbox" id="gp10a-5" value="5" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp10a-5" value="5">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp10a">
                                        <?php
                                        if ($gp10a_rate == '4') {
                                            echo '<input type="checkbox" id="gp10a-4" value="4" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp10a-4" value="4">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp10a">
                                        <?php
                                        if ($gp10a_rate == '3') {
                                            echo '<input type="checkbox" id="gp10a-3" value="3" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp10a-3" value="3">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp10a">
                                        <?php
                                        if ($gp10a_rate == '2') {
                                            echo '<input type="checkbox" id="gp10a-2" value="2" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp10a-2" value="2">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp10a">
                                        <?php
                                        if ($gp10a_rate == '1') {
                                            echo '<input type="checkbox" id="gp10a-1" value="1" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp10a-1" value="1">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp10a">
                                        <?php
                                        if ($gp10a_rate == '0') {
                                            echo '<input type="checkbox" id="gp10a-na" value="0" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp10a-na" value="0">';
                                        }
                                        ?>
                            ...
                            <div id="gp10b" class="row">
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp10b">
                                        <?php
                                        if ($gp10b_rate == '5') {
                                            echo '<input type="checkbox" id="gp10b-5" value="5" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp10b-5" value="5">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp10b">
                                        <?php
                                        if ($gp10b_rate == '4') {
                                            echo '<input type="checkbox" id="gp10b-4" value="4" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp10b-4" value="4">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp10b">
                                        <?php
                                        if ($gp10b_rate == '3') {
                                            echo '<input type="checkbox" id="gp10b-3" value="3" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp10b-3" value="3">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp10b">
                                        <?php
                                        if ($gp10b_rate == '2') {
                                            echo '<input type="checkbox" id="gp10b-2" value="2" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp10b-2" value="2">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp10b">
                                        <?php
                                        if ($gp10b_rate == '1') {
                                            echo '<input type="checkbox" id="gp10b-1" value="1" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp10b-1" value="1">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp10b">
                                        <?php
                                        if ($gp10b_rate == '0') {
                                            echo '<input type="checkbox" id="gp10b-na" value="0" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp10b-na" value="0">';
                                        }
                                        ?>
                            ...
                            <div id="gp10c" class="row">
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp10c">
                                        <?php
                                        if ($gp10c_rate == '5') {
                                            echo '<input type="checkbox" id="gp10c-5" value="5" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp10c-5" value="5">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp10c">
                                        <?php
                                        if ($gp10c_rate == '4') {
                                            echo '<input type="checkbox" id="gp10c-4" value="4" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp10c-4" value="4">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp10c">
                                        <?php
                                        if ($gp10c_rate == '3') {
                                            echo '<input type="checkbox" id="gp10c-3" value="3" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp10c-3" value="3">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp10c">
                                        <?php
                                        if ($gp10c_rate == '2') {
                                            echo '<input type="checkbox" id="gp10c-2" value="2" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp10c-2" value="2">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp10c">
                                        <?php
                                        if ($gp10c_rate == '1') {
                                            echo '<input type="checkbox" id="gp10c-1" value="1" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp10c-1" value="1">';
                                        }
                                        ?>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <span class="checkbox-gp10c">
                                        <?php
                                        if ($gp10c_rate == '0') {
                                            echo '<input type="checkbox" id="gp10c-na" value="0" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="gp10c-na" value="0">';
                                        }
                                        ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <span class="checkbox-oap">
                                        <?php
                                        if ($oap_scale == '5') {
                                            echo '<input type="checkbox" id="rating-5" value="5" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="rating-5" value="5">';
                                        }
                                        ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <span class="checkbox-oap">
                                        <?php
                                        if ($oap_scale == '4') {
                                            echo '<input type="checkbox" id="rating-4" value="4" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="rating-4" value="4">';
                                        }
                                        ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <span class="checkbox-oap">
                                        <?php
                                        if ($oap_scale == '3') {
                                            echo '<input type="checkbox" id="rating-3" value="3" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="rating-3" value="3">';
                                        }
                                        ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <span class="checkbox-oap">
                                        <?php
                                        if ($oap_scale == '2') {
                                            echo '<input type="checkbox" id="rating-2" value="2" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="rating-2" value="2">';
                                        }
                                        ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <span class="checkbox-oap">
                                        <?php
                                        if ($oap_scale == '1') {
                                            echo '<input type="checkbox" id="rating-1" value="1" checked>';
                                        } else {
                                            echo '<input type="checkbox" id="rating-1" value="1">';
                                        }
                                        ?>
                    ...
                    <div class="development">
                        <div id="prof-dev" class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                $result = in_array('Business and Organizational Development', $data);
                                if ($result) {
                                    echo '<input type="checkbox" id="area-1" value="Business and Organizational Development" checked>';
                                } else {
                                    echo '<input type="checkbox" id="area-1" value="Business and Organizational Development">';
                                }
                                ?>
                            ...
                            <div class="col-md-5">
                                ...
                                if ($result) {
                                    echo '<input type="checkbox" id="area-2" value="Business Communication" checked>';
                                } else {
                                    echo '<input type="checkbox" id="area-2" value="Business Communication">';
                                }
                                ?>
                            ...
                            <div class="col-md-6">
                                ...
                                if ($result) {
                                    echo '<input type="checkbox" id="area-3" value="Operational Excellence (Technical)" checked>';
                                } else {
                                    echo '<input type="checkbox" id="area-3" value="Operational Excellence (Technical)">';
                                }
                                ?>
                            ...
                            <div class="col-md-5">
                                ...
                                if ($result) {
                                    echo '<input type="checkbox" id="area-4" value="Presentation Skills" checked>';
                                } else {
                                    echo '<input type="checkbox" id="area-4" value="Presentation Skills">';
                                }
                                ?>
                            ...
                            <div class="col-md-6">
                                ...
                                if ($result) {
                                    echo '<input type="checkbox" id="area-5" value="Leadership Skills Training" checked>';
                                } else {
                                    echo '<input type="checkbox" id="area-5" value="Leadership Skills Training">';
                                }
                                ?>
                            ...
                            <div class="col-md-5">
                                ...
                                if ($result) {
                                    echo '<input type="checkbox" id="area-6" value="Customer Service" checked>';
                                } else {
                                    echo '<input type="checkbox" id="area-6" value="Customer Service">';
                                }
                                ?>
                            ...
                            <div class="col-md-6">
                                ...
                                if ($result) {
                                    echo '<input type="checkbox" id="area-7" value="Supervisory Skills Training" checked>';
                                } else {
                                    echo '<input type="checkbox" id="area-7" value="Supervisory Skills Training">';
                                }
                                ?>
                            ...
                            <div class="col-md-5">
                                ...
                                if ($result) {
                                    echo '<input type="checkbox" id="area-8" value="Personality Development" checked>';
                                } else {
                                    echo '<input type="checkbox" id="area-8" value="Personality Development">';
                                }
                                ?>
                                <label for="area-8">Personality Development</label>
                            </div>
                            <div class="col-md-1"></div>
                            <div class="col-md-4"><textarea id="prof-others" placeholder="Others Please Specify" rows="2"><?php echo $prof_others; ?></textarea></div>
                        </div><br>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-4"><input type="text" id="pin-1" value="<?php echo $pin1; ?>" /></div>
                                <div class="col-md-3"><input type="text" id="at-1" value="<?php echo $at1; ?>" /></div>
                                <div class="col-md-3"><input type="text" id="sn-1" value="<?php echo $sn1; ?>" /></div>
                                <div class="col-md-2"><input type="text" id="timeline-1" value="<?php echo $time1; ?>" /></div>
                            </div>
                            <div class="row">
                                <div class="col-md-4"><input type="text" id="pin-2" value="<?php echo $pin2; ?>" /></div>
                                <div class="col-md-3"><input type="text" id="at-2" value="<?php echo $at2; ?>" /></div>
                                <div class="col-md-3"><input type="text" id="sn-2" value="<?php echo $sn2; ?>" /></div>
                                <div class="col-md-2"><input type="text" id="timeline-2" value="<?php echo $time2; ?>" /></div>
                            </div>
                            <div class="row">
                                <div class="col-md-4"><input type="text" id="pin-3" value="<?php echo $pin3; ?>" /></div>
                                <div class="col-md-3"><input type="text" id="at-3" value="<?php echo $at3; ?>" /></div>
                                <div class="col-md-3"><input type="text" id="sn-3" value="<?php echo $sn3; ?>" /></div>
                                <div class="col-md-2"><input type="text" id="timeline-3" value="<?php echo $time3; ?>" /></div>
                            </div>
                        </div>
                    </div><br>
                    <!-- EMPLOYEE'S COMMENTS -->
                    ...
                    <div class="row">
                        ...
                        <div class="row checkbox-recommend">
                            ...
                            <div class="col-md-5 checkbox-hr">
                                ...
                                if ($result) {
                                    echo '<input type="checkbox" class="checkbox-recommend" id="recommend-0" value="No Change" checked>';
                                } else {
                                    echo '<input type="checkbox" class="checkbox-recommend" id="recommend-0" value="No Change">';
                                }
                                ?>
                            ...
                            <div class="col-md-5">
                                ...
                                if ($result) {
                                    echo '<input type="checkbox" class="checkbox-recommend" id="recommend-1" value="For Regularization" checked>';
                                } else {
                                    echo '<input type="checkbox" class="checkbox-recommend" id="recommend-1" value="For Regularization">';
                                }
                                ?>
                            ...
                            <div class="col-md-5 checkbox-hr">
                                ...
                                if ($result) {
                                    echo '<input type="checkbox" class="checkbox-recommend" id="recommend-2" value="End of Employment" checked>';
                                } else {
                                    echo '<input type="checkbox" class="checkbox-recommend" id="recommend-2" value="End of Employment">';
                                }
                                ?>
                            ...
                            <div class="col-md-5">
                                ...
                                if ($result) {
                                    echo '<input type="checkbox" class="checkbox-recommend" id="recommend-3" value="For Promotion" checked>';
                                } else {
                                    echo '<input type="checkbox" class="checkbox-recommend" id="recommend-3" value="For Promotion">';
                                }
                                ?>
                            ...
                            <div class="col-md-5 checkbox-hr">
                                ...
                                if ($result) {
                                    echo '<input type="checkbox" class="checkbox-recommend" id="recommend-4" value="Transfer Department / Unit / Project" checked>';
                                } else {
                                    echo '<input type="checkbox" class="checkbox-recommend" id="recommend-4" value="Transfer Department / Unit / Project">';
                                }
                                ?>
                            ...
                            <div class="col-md-6">
                                ...
                                if ($result) {
                                    echo '<input type="checkbox" class="checkbox-recommend" id="recommend-5" value="For Salary Adjustment" checked>';
                                } else {
                                    echo '<input type="checkbox" class="checkbox-recommend" id="recommend-5" value="For Salary Adjustment">';
                                }
                                ?>
                            ...
                            <div class="col-md-5 checkbox-hr">
                                ...
                                if ($result) {
                                    echo '<input type="checkbox" class="checkbox-recommend" id="recommend-6" value="Mid-Year Assessment" checked>';
                                } else {
                                    echo '<input type="checkbox" class="checkbox-recommend" id="recommend-6" value="Mid-Year Assessment">';
                                }
                                ?>
                    ...
                    <div class="row">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <div class="col-md-3">
                            <a id="btnSubmit" class="button fit"><i class="fa fa-check-circle"></i><b style="color: whitesmoke;"> APPROVE & SUBMIT</b></a>
    ...
    <?php include 'js/uneval_par_app2-js.php'; ?>
