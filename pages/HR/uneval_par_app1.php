...
<body id="page-top" class="subpage">
                        ...
                        <div class="row uniform">
                            ...
                            <div class="3u 12u$(xsmall)">
                                ...
                                while ($row_count = $count->fetch(PDO::FETCH_ASSOC)) {
                                    if ($row_count['counts'] > 0) {
                                        ...
                                        echo '<select id="project" disabled>';
                            ...
                            <div class="3u 12u$(xsmall)">
                                <select id="rater" disabled>
                                    <option value="0" <?php echo ($rater == '- First Rater-') ? 'selected disabled' : ''; ?>>- First Rater -</option>
                                    <option value="2" <?php echo ($rater == 'Immediate Superior' || $rater == 2) ? 'selected' : ''; ?>>Immediate Superior</option>
                                    <option value="3" <?php echo ($rater == 'Manager' || $rater == 3) ? 'selected' : ''; ?>>Manager</option>
                                    <option value="4" <?php echo ($rater == 'Sr. Manager' || $rater == 4) ? 'selected' : ''; ?>>Sr. Manager</option>
                            ...
                            <div class="3u 12u$(xsmall)">
                                <input type="text" id="emp_email" value="<?php echo $emp_email; ?>" disabled>
                            </div>
                    </form>
                </div>
            </div>
            ...
            <div class="box">
                <div class="content">
                    ...
                    <div class="comments">
                        ...
                        <div class="col-md-12"><textarea id="emp-comments" placeholder="Enter comments here" rows="2" disabled><?php echo $emp_comment; ?></textarea>
                        </div>
                    </div><br>
    ...
    <?php include 'js/uneval_par_app1-js.php'; ?>
