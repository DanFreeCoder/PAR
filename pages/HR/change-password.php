...
<body id="page-top" class="subpage">
    ...
    <section id="two" class="wrapper style2">
        <div class="inner">
            <div class="box">
                <div class="content">
                    <center>
                        <h3>First time to login? Please change your password to secure your account.</h3>
                    </center>
                    <hr>
    ...
    <script>
        ...
        $('#btnSubmit').on('click', function(e) {
            ...
            var password2 = $('#password2').val();
            var action = 4;
            var myData = 'id=' + id + '&username=' + username + '&firstname=' + firstname + '&lastname=' + lastname + '&password=' + password1 + '&access=' + access + '&role=' + role + '&action=' + action;
