...
<body id="page-top" class="subpage">
                    ...
                    <form method="post" action="#">
                        <div class="row uniform">
                            <div class="3u 12u$(xsmall)">
                                <input type="text" id="eval_by" placeholder="Employee's Name" value="<?php echo $_SESSION['id']; ?>" hidden>
                                <input type="text" id="id" placeholder="Employee's Name" value="<?php echo $par_id; ?>" hidden>
                                <input type="text" id="name" placeholder="Employee's Name" value="<?php echo $emp_name; ?>" disabled>
                                <input type="text" id="access" value="<?php echo $_SESSION['access']; ?>" hidden>
                            </div>
                            <div class="3u 12u$(xsmall)">
                            ...
                            <div class="3u 12u$(xsmall)">
                                <input type="text" id="rater_name" value="<?php echo $rater_name; ?>" disabled />
                                <input type="text" id="assignee" style="display: none" value="<?php echo $rater_id; ?>" disabled />
                            </div>
                            <div class="3u 12u$(xsmall)">
                    ...
                    <div class="development">
                        <div id="prof-dev" class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                if ($result) {
                                    echo '<input type="checkbox" id="area-1" value="Business & Organizational Development" checked>';
                                } else {
                                    echo '<input type="checkbox" id="area-1" value="Business & Organizational Development">';
                                }
                                ?>
    ...
    <?php include 'js/uneval_par_app3-js.php'; ?>
