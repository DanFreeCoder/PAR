...
//ALL OF THIS FUNCTION IS FOR THE PAGE WITH THE SUPERVISOR COMMENT
...
function restriction_of_txtbox(myData, action_s) {
    ...
    //supervisor comment
    var sup_comment1 = $('#sup-comment1').val();
    var sup_comment2 = $('#sup-comment2').val();
    var sup_comment3 = $('#sup-comment3').val();
    var sup_comment4 = $('#sup-comment4').val();
    var sup_comment5 = $('#sup-comment5').val();
    var sup_comment6 = $('#sup-comment6').val();
    ...
    switch (true) {
        ...
        default:
            if (action_s == 113) {
                //btn Submit APPROVER 1 (UNEVAL_PAR)
                $.ajax({
                    type: 'POST',
            ...
            } else if (action_s == 114) {
                //btn Draft APPROVER 1 (UNEVAL_PAR)
                $.ajax({
                    type: 'POST',
                    url: '../../controls/save_supDraft.php',
                    data: myData,
                    beforeSend: function () {
                        showToast();
                    },
                    success: function (response) {
                        if (response > 0) {
                            toastr.info('Employee PAR successfully save as draft.');
                            //back to top
                            //window.scrollTo(0,0);
                        } else {
                            toastr.error('ERROR! Submit Failed. Please contact the system administrator at local 124 for assistance');
            ...
            } else if (action_s == 115) {
                //btn Submit Approver 1 (DRAFT_EVAL_PAR)
                $.ajax({
                    type: 'POST',
                    url: '../../controls/save_supPAR.php',
                    data: myData,
            ...
            } else if (action_s == 116) {
                //btn Draft Approver 1 (DRAFT_EVAL_PAR)
                $.ajax({
                    type: 'POST',
                    url: '../../controls/save_supDraft.php',
                    data: myData,
            ...
            } else if (action_s == 117) {
                //btn Submit Approver 1 (EVAL_PAR)
                $.ajax({
                    type: 'POST',
                    url: '../../controls/save_supPAR.php',
                    data: myData,
            ...
            } else if (action_s == 232) {
                //btn Submit Approver 2 (UNEVAL_PAR)
                $.ajax({
                    type: 'POST',
                    url: '../../controls/save_supPAR.php',
                    data: myData,
            ...
            } else if (action_s == 233) {
                //btn Draft Approver 2 (UNEVAL_PAR)
                $.ajax({
                    type: 'POST',
                    url: '../../controls/save_supDraft.php',
                    data: myData,
            ...
            } else if (action_s == 234) {
                //btn Update(ApprovePAR) Approver 2 (EVAL_PAR)
                $.ajax({
                    type: 'POST',
                    url: '../../controls/accept_par_app2.php',
                    data: myData,
                    beforeSend: function () {
                        showToast();
                    },
                    success: function (response) {
                        if (response > 0) {
                            toastr.success('Congratulations! PAR successfully updated.');
                            $('#btnPrint').show();
                            $('#btnUpdateRec').hide();
                            $('#btnMark').hide();
                        } else {
            ...
            } else if (action_s == 235) {
                //btn DECLINED Approver 2 (EVAL_PAR)
                $.ajax({
                    type: 'POST',
            ...
            } else if (action_s == 236) {
                //btn Update Approver 1 (DRAFT_EVAL_PAR)
                $.ajax({
                    type: 'POST',
                    url: '../../controls/accept_par.php',
                    data: myData,
                    beforeSend: function () {
                        showToast();
                    },
            ...
            } else if (action_s == 237) {
                //btn Submit approver 2 (DRAFT_EVAL_PAR)
                $.ajax({
                    type: 'POST',
                    url: '../../controls/save_supPAR.php',
                    data: myData,
            ...
            } else if (action_s == 238) {
                //btn Draft approver2 (DRAFT_EVAL_PAR)
                $.ajax({
                    type: 'POST',
                    url: '../../controls/save_supDraft.php',
                    data: myData,
            ...
            } else if (action_s == 243) {
                //btn Submit Approver3 (UNEVAL_PAR)
                // alert(action_s)
                $.ajax({
                    type: 'POST',
                    url: '../../controls/save_supPAR.php',
                    ...
                    success: function (response) {
                        if (response > 0) {
                            toastr.success('Congratulations! PAR successfully approved.');
                            $('#btnPrint').show();
                            $('#btnSubmit').hide();
                            $('#btnDraft').hide();
                            //back to top
            ...
            } else if (action_s == 244) {
                //btn Draft Approver 3 (UNEVAL_PAR)
                alert(action_s)
                $.ajax({
                    type: 'POST',
                    url: '../../controls/save_supDraft.php',
            ...
            } else if (action_s == 245) {
                //btn Submit Approver 3 (DRAFT_EVAL_PAR)
                $.ajax({
                    type: 'POST',
                    url: '../../controls/save_supPAR.php',
                    data: myData,
            ...
            } else if (action_s == 246) {
                //btn Draft Approver 3 (DRAFT_EVAL_PAR)
                $.ajax({
                    type: 'POST',
                    url: '../../controls/save_supDraft.php',
                    data: myData,
            ...
            } else if (action_s == 247) {
                //btn UPDATE Approver 3 (EVAL_PAR)
                $.ajax({
                    type: 'POST',
                    url: '../../controls/accept_par.php',
                    data: myData,
