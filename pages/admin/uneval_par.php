				...
				<div class="content">
					...
					<form method="post" action="#">
						<div class="row uniform">
							...
							<!-- Break -->
							<div class="3u 12u$(xsmall)">
								<input type="text" id="status" value="<?php echo $emp_status; ?>" />
							</div>
							<div class="3u 12u$(xsmall)">
								<input type="text" id="assessment" value="<?php echo $assessment; ?>" />
							</div>
							<div class="3u 12u$(xsmall)">
			...
			<div class="box">
				<div class="content">
					...
					<div class="row">
						...
						<div class="col-sm-3">
							<textarea name="message" id="comments1" placeholder="Enter comments here" rows="4"><?php echo $comments1; ?></textarea>
						</div>
						<div class="col-sm-3">
					...
					<div class="row">
						...
						<div class="col-sm-3">
							<textarea name="message" id="comments2" placeholder="Enter comments here" rows="4"><?php echo $comments2; ?></textarea>
						</div>
						<div class="col-sm-3">
					...
					<div class="row">
						...
						<div class="col-sm-3">
							<textarea name="message" id="comments3" placeholder="Enter comments here" rows="4"><?php echo $comments3; ?></textarea>
						</div>
						<div class="col-sm-3">
					...
					<div class="row">
						...
						<div class="col-sm-3">
							<textarea name="message" id="comments4" placeholder="Enter comments here" rows="4"><?php echo $comments4; ?></textarea>
						</div>
						<div class="col-sm-3">
					...
					<div class="row">
						...
						<div class="col-sm-3">
							<textarea name="message" id="comments5" placeholder="Enter comments here" rows="4"><?php echo $comments5; ?></textarea>
						</div>
						<div class="col-sm-3">
					...
					<div class="row">
						...
						<div class="col-sm-3">
							<textarea name="message" id="comments6" placeholder="Enter comments here" rows="4"><?php echo $comments6; ?></textarea>
						</div>
						<div class="col-sm-3">
					...
					<!-- HR REFERENCE -->
					<div class="row">
						<h4><b>FOR HR REFERENCE ONLY </b><b style="color: red;">*</b></h4>
						<div class="col-md-12">
							<div class="col-md-12">
								<center>
						...
						<div class="row checkbox-recommend">
							...
							<div class="col-md-1"></div>
							<div class="col-md-4">
								<textarea id="gross-pay" placeholder="Please specify monthly gross pay" rows="2"><?php echo $gross; ?></textarea>
							</div>
							<div class="col-md-2"></div>
							<div class="col-md-4">
								<textarea id="gross-remarks" placeholder="Please input remarks here" rows="2"><?php echo $remarks; ?></textarea>
							</div>
						</div><br>
					</div>
					<div class="row">
