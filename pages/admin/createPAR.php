					...
					<form method="post" action="#">
						<div class="row uniform">
							<div class="3u 12u$(xsmall)">
								<input type="text" id="name" placeholder="Employee's Name" />
							...
							<!-- Break -->
							<div class="3u 12u$(xsmall)">
								<input type="text" id="date-hire" class="datepicker" placeholder="Date Hired " />
							</div>
							<div class="3u$ 12u$(xsmall)">
								<div class="select-wrapper">
									<select id="rater">
							...
							<div class="3u 12u$(xsmall)">
								<input type="text" id="emp_email" placeholder="IGC Email" />
							</div>
					</form>
				</div>
			</div>
			...
			<div class="box">
				<div class="content">
					...
					<div class="row">
						...
						<div class="col-md-3">
							<input type="text" id="kra-total" placeholder="0.00%" disabled />
						</div>
						<div class="col-md-1" style="text-align: right;">
							<h4>60% =</h4>
						</div>
						<div class="col-md-3">
							<input type="text" id="kra-average" placeholder="0.00%" disabled />
						</div>
					</div><br>
					<!-- Break -->
					<div class="row">
						...
						<div class="col-md-3">
							<input type="text" id="gp-total" placeholder="0.00%" disabled />
						</div>
						<div class="col-md-1" style="text-align: right;">
							<h4>40% =</h4>
						</div>
						<div class="col-md-3">
							<input type="text" id="gp-average" placeholder="0.00%" disabled />
						</div>
					</div><br>
					<div class="row">
						<div class="col-md-9">
						...
						<div class="col-md-3">
							<input type="text" id="oap-rating" placeholder="0.00%" disabled>
						</div>
					</div>
					<hr><br>
					<!-- Break -->
					...
					<div class="development">
						<div id="prof-dev" class="row">
							...
							<div class="col-md-1"></div>
							<div class="col-md-4"><textarea id="prof-others" placeholder="Others Please Specify" rows="2"></textarea></div>
						</div><br>
					...
					<div class="comments">
						...
						<div class="col-md-12"><textarea id="emp-comments" placeholder="Enter comments here" rows="2"></textarea></div>
					</div><br>
					<!-- HR REFERENCE -->
					<div class="row hr-reference">
						<h4><b>FOR HR REFERENCE ONLY</b></h4>
						<div class="col-md-12">
							<div class="col-md-12">
								<center>
						...
						<div class="row checkbox-recommend">
							<div class="col-md-1"></div>
							<div class="col-md-6">
								<input type="checkbox" id="rec-1" value="For Regularization">
								<label for="rec-1">For Regularization</label>
							</div>
							<div class="col-md-5">
								<input type="checkbox" id="rec-2" value="End of Employment">
								<label for="rec-2">End of Employment</label>
							</div>
							<div class="col-md-1"></div>
							<div class="col-md-6">
								<input type="checkbox" id="rec-3" value="For Promotion">
								<label for="rec-3">For Promotion</label>
							</div>
							<div class="col-md-5">
								<input type="checkbox" id="rec-4" value="Transfer Department / Unit / Project">
								<label for="rec-4">Transfer Department / Unit / Project</label>
							</div>
							<div class="col-md-1"></div>
							<div class="col-md-6">
								<input type="checkbox" id="rec-5" value="For Salary Adjustment">
								<label for="rec-5">For Salary Adjustment</label>
							</div>
							<div class="col-md-5">
								<input type="checkbox" id="rec-6" value="Mid Year Assessment">
								<label for="rec-6">Mid Year Assessment</label>
							</div>
							<div class="col-md-4">
