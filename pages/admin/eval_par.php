					...
					<form method="post" action="#">
						<div class="row uniform">
							<div class="3u 12u$(xsmall)">
								<input type="text" id="id" style="display:none" value="<?php echo $sup_id; ?>" />
								<input type="text" id="par-id" style="display:none" value="<?php echo $details_id; ?>" />
								<input type="text" id="rater_id" style="display:none" value="<?php echo $_SESSION['id']; ?>" />
			...
			<div class="box">
				<div class="content">
					...
					<div class="row">
						...
						<div class="col-md-3">
							<input type="text" id="kra-total" placeholder="0.00%" value="<?php echo $kra_total; ?>" />
						</div>
						<div class="col-md-1" style="text-align: right;">
							<h4>60% =</h4>
						</div>
						<div class="col-md-3">
							<input type="text" id="kra-average" placeholder="0.00%" value="<?php echo $kra_average; ?>" />
						</div>
					</div><br>
					<!-- Break -->
					<div class="row">
						...
						<div class="col-md-3">
							<input type="text" id="gp-total" placeholder="0.00%" value="<?php echo $gp_total; ?>" />
						</div>
						<div class="col-md-1" style="text-align: right;">
							<h4>40% =</h4>
						</div>
						<div class="col-md-3">
							<input type="text" id="gp-average" placeholder="0.00%" value="<?php echo $gp_average; ?>" />
						</div>
					</div><br>
					<div class="row">
						<div class="col-md-9">
						...
						<div class="col-md-3">
							<input type="text" id="oap-rating" placeholder="0.00%" value="<?php echo $oap_total; ?>" />
						</div>
					</div>
					<hr><br>
					<!-- Break -->
					...
					<div class="development">
						<div id="prof-dev" class="row">
							<div class="col-md-12">
								...
								<div class="col-md-12">
									<h4><b style="color: red;">*</b><b>IV A. Recommendations for professional development [seminars, training, OJT, etc.]:</b><br><i>Please check the training program/s which will help address the employee's areas of development</i></h4>
								</div>
							</div>
					...
					<!-- HR REFERENCE -->
					<div class="row hr-reference">
						<h4><b>FOR HR REFERENCE ONLY <b style="color: red;">*</b></b></h4>
						<div class="col-md-12">
							<div class="col-md-12">
								<center>
						...
						<div class="row checkbox-recommend">
							...
							<div class="col-md-6">
								...
								if ($result) {
									echo '<input type="checkbox" id="hr-rec-1" value="For Regularization" checked>';
								} else {
									echo '<input type="checkbox" id="hr-rec-1" value="For Regularization">';
								}
								?>
								<label for="hr-rec-1">For Regularization</label>
							</div>
							<div class="col-md-5">
								<?php
								$data = explode(',', $recommendation);
								...
								if ($result) {
									echo '<input type="checkbox" id="hr-rec-2" value="End of Employment" checked>';
								} else {
									echo '<input type="checkbox" id="hr-rec-2" value="End of Employment">';
								}
								?>
								<label for="hr-rec-2">End of Employment</label>
							</div>
							<div class="col-md-1"></div>
							<div class="col-md-6">
								<?php
								...
								if ($result) {
									echo '<input type="checkbox" id="hr-rec-3" value="For Promotion" checked>';
								} else {
									echo '<input type="checkbox" id="hr-rec-3" value="For Promotion">';
								}
								?>
								<label for="hr-rec-3">For Promotion</label>
							</div>
							<div class="col-md-5">
								<?php
								$data = explode(',', $recommendation);
								...
								if ($result) {
									echo '<input type="checkbox" id="hr-rec-4" value="Transfer Department / Unit / Project" checked>';
								} else {
									echo '<input type="checkbox" id="hr-rec-4" value="Transfer Department / Unit / Project">';
								}
								?>
								<label for="hr-rec-4">Transfer Department / Unit / Project</label>
							</div>
							<div class="col-md-1"></div>
							<div class="col-md-6">
								<?php
								...
								if ($result) {
									echo '<input type="checkbox" id="hr-rec-5" value="For Salary Adjustment" checked>';
								} else {
									echo '<input type="checkbox" id="hr-rec-5" value="For Salary Adjustment">';
								}
								?>
								<label for="hr-rec-5">For Salary Adjustment</label>
							</div>
							<div class="col-md-5">
								<?php
								$data = explode(',', $recommendation);
								...
								if ($result) {
									echo '<input type="checkbox" id="rec-4" value="Mid-Year Assessment" checked>';
								} else {
									echo '<input type="checkbox" id="rec-4" value="Mid-Year Assessment">';
								}
								?>
								<label for="rec-4">Mid-Year/Annual Assessment</label>
							</div>
							<div class="col-md-1"></div>
							<div class="col-md-4">
					...
					<div class="row">
						...
						<div class="col-md-3">
							<?php
							if ($par_status == 4) {
								echo '<a id="btnPrintApproved" class="button fit" style="background-color: #1191EA;"><i class="fa fa-print"></i><b style="color: whitesmoke;"> PRINT PAR</b></a>';
							} else {
								echo '<a id="btnSubmit" class="button fit"><i class="fa fa-check-circle"></i><b style="color: whitesmoke;"> UPDATE & SUBMIT</b></a>
					...
					<?php
					//check if it is mark for revision
					if ($revision != null || $revision != '') {

						echo '<div class="row mark-reason">
												<div class="col-md-12"><h4><b>REASON OF REVISION:</b></h4></div>
												<div class="col-md-12"><textarea id="reason" placeholder="Please input your reason here" rows="3" disabled>' . $revision . '</textarea></div>
											  </div>';
					} else {
						echo '<div class="row mark-reason" style="display:none;">
												<div class="col-md-12"><h4><b>REASON OF REVISION:</b></h4></div>
												<div class="col-md-12"><textarea id="reason" placeholder="Please input your reason here" rows="3"></textarea></div>
										      </div>';
					}
					?>
					</form>
